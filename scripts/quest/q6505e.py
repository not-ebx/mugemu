...
sm.sendNext("Hmm... You're that #h # person #p" + str(lana) + "# mentioned? "
"You look like a normal person...why would you want to eat... Oh, never mind. "
"Here's the dish #p" + str(lana) + "# ordered for you. Enjoy...")

sm.setPlayerAsSpeaker()
sm.sendSay("#b(You ate the food #p" + str(tangyoon) + "# gave you... "
"You were a bit nervous at first, but it tasted rather good.)")

sm.setSpeakerID(tangyoon)
sm.sendSay("Is it good? Of course it's good! "
"I, the great #p" + str(tangyoon) + "#, can make anything taste good! "
