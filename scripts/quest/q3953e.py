...
resOne = sm.sendNext("If you're going to keep blabbing some nonsense about how Deo has turned into a monster, I'm not interested! "
        ...
        "Hmm... you're giving this to me? Well... I can't say no to Lidium. Fine... what is it?\r\n\r\n#b"
...
if resOne == 1:
    resTwo = sm.sendNext("The merchants? ...They probably lacked protection. "
            ...
            "You must be careful in the desert. \r\n\r\n#b"
    ...
    if resTwo == 1:
        resThree = sm.sendNext("You're right! It's because of the Queen! "
            ...
            "like an oasis drying out! And it's all her fault! \r\n\r\n#b"
        ...
        if resThree == 0:
            ...
            if resFour == 0:
                ...
                "But he's the guardian deity of Ariant... Well, Ariant isn't the same as it used to be. \r\n\r\n#b"
