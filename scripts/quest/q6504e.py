...
sm.sendSay("#b(You must horrify Dr. #p" + str(betty) + "#. "
"What could you say to Dr. #p" + str(betty) + "# to draw that kind of reaction...?)")

sm.setSpeakerID(betty)
response = sm.sendNext("#b(What would horrify Dr. Betty?) \r\n\r\n"
"#L0#Do you know Dr. Winston in #m" + str(perion) + "#?#l\r\n"
...
if response == 0:
    ...
    "#i" + str(panicky) + "# #t" + str(panicky) + "# x 1")
