...
import net.mugeemu.ms.client.party.PartyDamageInfo;
...
import net.mugeemu.ms.enums.EliteState;
import net.mugeemu.ms.enums.WeatherEffNoticeType;
...
import net.mugeemu.ms.life.mob.skill.ShootingMoveStat;
...
public class Mob extends Life {
    ...
    public void spawnEliteVersion() {
        ...
        Map<Integer, Integer> possibleSkillsMap = new HashMap<>();//SkillData.getEliteMobSkillsByGrade(eliteGrade);
