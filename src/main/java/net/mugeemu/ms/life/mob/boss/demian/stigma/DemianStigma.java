...
public class DemianStigma {
    ...
    public static int getStigmaCount(Char chr) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if (tsm.hasStat(CharacterTemporaryStat.Stigma)) {
            return tsm.getOption(CharacterTemporaryStat.Stigma).nOption;
        }
        return 0;
    }
    ...
    public static int getCorruptionCount(Char chr) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if (tsm.hasStat(CharacterTemporaryStat.Stigma)) {
            return tsm.getOption(CharacterTemporaryStat.Stigma).xOption;
        }
        return 0;
    }
}
