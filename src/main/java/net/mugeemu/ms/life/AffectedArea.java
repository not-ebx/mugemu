...
import net.mugeemu.ms.life.mob.boss.demian.sword.DemianFlyingSword;
import net.mugeemu.ms.life.mob.boss.demian.sword.DemianFlyingSwordPath;
...
import net.mugeemu.ms.client.jobs.adventurer.Archer;
    ...
    public void handleCharInside(Char chr) {
        ...
        switch (skillID) {
            ...
            case Kanna.BELLFLOWER_BARRIER:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.bdR, slv);
                o1.tStart = (int) System.currentTimeMillis();
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieBDR, o1); // Indie
                break;
            ...
            case Aran.MAHAS_DOMAIN:
                chr.heal((int) (chr.getMaxHP() / ((double) 100 / si.getValue(SkillStat.w, slv))));
                chr.healMP((int) (chr.getMaxHP() / ((double) 100 / si.getValue(SkillStat.w, slv))));
                tsm.removeAllDebuffs();
                break;
            case Thief.SMOKE_SCREEN:
                o1.nOption = 1;
                tsm.putCharacterStatValue(CharacterTemporaryStat.Invincible, o1);
            ...
            case Xenon.TEMPORAL_POD:
                o1.nOption = 2;
                o1.rOption = skillID;
                tsm.putCharacterStatValue(CharacterTemporaryStat.OnCapsule, o1);
