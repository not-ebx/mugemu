...
public enum OutHeader {
    ...
    CHANGE_SPW_RESULT(29),
    ALBA_RESULT(290000),
    SET_HOT_FIX(36000),

    // CChatSocket::ProcessPacket
    CHAT_LOGIN_RESULT(1111),
    CHAT_LOGOUT_RESULT(1111),
    CHAT_ALIVE_REQ(13111),
    CHAT_ENTER_GUILD_CHAT_ROOM_RESULT(15111),
    CHAT_GUILD_CHAT_MESSAGE(11118),
    CHAT_FRIEND_CHAT_MESSAGE(19111),
    CHAT_BLOCK_GUILD_FRIEND_CHAT(21118),

    // CMapLoadable::OnPacket
    SET_BACK_EFFECT(5113),
    SET_MAP_TAGGED_OBJECT_VISISBLE(5114),
    ...
    INVENTORY_GROW(31),
    STAT_CHANGED(32),
    TEMPORARY_STAT_SET(33),
    TEMPORARY_STAT_RESET(34),
    FORCED_STAT_SET(35),
    FORCED_STAT_RESET(36),
    CHANGE_SKILL_RECORD_RESULT(37),

    SKILL_USE_RESULT(38),

    GIVE_POPULARITY_RESULT(39),
    CHANGE_STEAL_MEMORY_RESULT(999), //DELETE
    ...
    CLAIM_RESULT(46),
    SET_CLAIM_SVR_AVAILABLE_TIME(47),
    CLAIM_SVR_STATUS_CHANGED(48),
    SET_TAMING_MOB_INFO(49),
    QUEST_CLEAR(50),
    ENTRUSTED_SHOP_CHECK_RESULT(51),
    SKILL_LEARN_ITEM_RESULT(52),
    SKILL_RESET_ITEM_RESULT(53),
    ABILITY_RESET_ITEM_RESULT(54),
    ...
    CHARACTER_INFO(62),
    PARTY_RESULT(64),
    PARTY_MEMBER_CANDIDATE_RESULT(11115),
    PARTY_CANDIDATE_RESULT(6401),
    EXPEDITION_RESULT(65),
    FRIEND_RESULT(66), // I think
    LOAD_ACCOUNT_ID_OF_CHARACTER_FRIEND_RESULT(125),
    GUILD_REQUEST(67), // Guess. Unsure about those 2
    GUILD_RESULT(68),
    ALLIANCE_RESULT(69),
    TOWN_PORTAL(71), //unsure
    // spawn portal is 70; open_gate = 71
    BROADCAST_MSG(72),
    INCUBATOR_RESULT(73),
    ...
    CASHPET_FOOD_RESULT(80),
    CASHPET_PICK_UP_ON_OFF_RESULT(666143), //?
    CASHPET_SKILL_SETTING_RESULT(666144), //?
    CASH_LOOK_CHANGE_RESULT(666145), //?
    ...
    HOUR_CHANGE(89),
    MINIMAP_ON_OFF(90),
    CONSULT_AUTH_KEY_UPDATE(91),
    CLASS_COMPETITION_AUTH_KEY_UPDATE(92),
    WEB_BOARD_AUTH_KEY_UPDATE(93),
    SESSION_VALUE(94), // We
    PARTY_VALUE(95),
    FIELD_SET_VARIABLE(96),
    FIELD_VALUE(96), // uinsure whats this
    BONUS_EXP_RATE_CHANGED(97),
    POTION_DISCOUNT_RATE_CHANGED(98),
    FAMILY_CHART_RESULT(99),
    FAMILY_INFO_RESULT(100),
    FAMILY_RESULT(101),
    FAMILY_JOIN_REQUEST(102),
    FAMILY_JOIN_REQUEST_RESULT(103),
    FAMILY_JOIN_ACCEPTED(104),
    FAMILY_PRIVILEGE_LIST(105),
    FAMILY_FAMOUS_POINT_INC_RESULT(106),
    FAMILY_NOTIFY_LOGIN_OR_LOGOUT(107),
    FAMILY_SET_PRIVILEGE(106),
    FAMILY_SUMMON_REQUEST(107),
    NOTIFY_LEVEL_UP(110),
    NOTIFY_WEDDING(111),
    NOTIFY_JOB_CHANGE(112),
    SET_BUY_EQUIP_EXT(180),
    SET_PASSENSER_REQUEST(181), // typo?
    //SCRIPT_PROGRESS_MESSAGE_BY_SOUL(1820),
    SCRIPT_PROGRESS_MESSAGE(128), //
    ...
    AVATAR_MEGAPHONE_RES(271233),
    SET_AVATAR_MEGAPHONE(271114),
    CLEAR_AVATAR_MEGAPHONE(271115),
    EVENT_NAME_TAG(207),
    ...
    PENDANT_SLOT_INC_RESULT(31103),
    BOSS_ARENA_MATCH_SUCCESS(30114),
    ...
    CHAT_NLCPQ(179),
    AD_BOARD(181),
    MINI_ROOM_BALLOON(182),
    //SET_CONSUME_ITEM_EFFECT(521),
    SHOW_ITEM_UPGRADE_EFFECT(183),
    SHOW_ITEM_SKILL_SOCKET_UPGRADE_EFFECT(184),
    SHOW_ITEM_SKILL_OPTION_UPGRADE_EFFECT(185),
    SHOW_ITEM_RELEASE_EFFECT(186),
    SHOW_ITEM_UNRELEASE_EFFECT(187),
    ...
    RED_CUBE_RESULT(534),
    HIT_BY_USER(189), // OnHitByUser -> KMST, verified v176 idb
    DOT_BY_USER(536), // OnDotByUser
    RESET_ALL_DOT(537), // OnResetAllDot
    DAMAGE_BY_USER(538), // OnDamageByUser
    TESLA_TRIANGLE(190),
    FOLLOW_CHARACTER(191),
    SHOW_PQ_REWARD(192), //Phase?
    ...
    EMOTION(685),
    EFFECT(153), // guess
    TELEPORT(236), // This is 'dojo_warp_up'
    MESO_GIVE_SUCCEEDED(321), // Is this lucksack?
    ...
    MAKER_RESULT(250),
    OPEN_CLASS_COMPETION_TIPAGE(252), // Guess
    OPEN_UI(253),
    CLOSE_UI(254),
    OPEN_UI_WITH_OPTION(254),
    OPEN_WEB_UI(255), // LOCK_UI?
    ...
    MOB_ENTER_FIELD(276), //
    MOB_LEAVE_FIELD(277), //
    MOB_CHANGE_CONTROLLER(278),
    MOB_SET_AFTER_ATTACK(911),
    MOB_BLOCK_ATTACK(912),
    MOB_CRC_KEY_CHANGED(289), // v92
    ...
    MOB_AFFECTED(285),
    MOB_DAMAGED(286),
    MOB_SPECIAL_EFFECT_BY_SKILL(287),
    MOB_CRC_DATA_REQUEST(289000),
    MOB_HP_INDICATOR(290),
    MOB_CATCH_EFFECT(291),
    MOB_STEAL_EFFECT(292),
    ...
    NPC_ENTER_FIELD(303), //
    NPC_LEAVE_FIELD(304), //
    NPC_CHANGE_CONTROLLER(305), //
    NPC_IMITATE_DATA(101), //
    NPC_UPDATE_LIMITED_DISABLE_INFO(307), //
    SET_NPC_SCRIPT(309), //
    ...
    COMPLETE_RUNE(1166),
    ARIANT_SCORE(349),
    HORNTAIL_TIMER(350), // HORNTAIL CAVE
    ZAKUM_TIMER(351), // ZAKUM TIMER
    TRUNK_DLG(1308),
    RPS_GAME_DLG(1311),
