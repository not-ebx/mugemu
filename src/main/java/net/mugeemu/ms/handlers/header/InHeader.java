...
public enum InHeader {
    ...
    WORLD_LIST_REQUEST(31),
    SELECT_PREVIOUS_WORLD(24),
    SELECT_WORLD(25),

    SERVERSTATUS_REQUEST(26),
    REDISPLAY_SERVERLIST(32),

    CHAR_SELECT_NO_PIC(39),

    MIGRATE_IN(40),
    CHECK_DUPLICATE_ID(41),
    CREATE_NEW_CHARACTER(42),


    VIEW_REGISTER_PIC(52),
    VIEW_SELECT_PIC(53),
    //CLIENT_FAILED(59),
    CLIENT_ERROR(59),
    ...
    ALBA_REQUEST(142),
    UPDATE_CHARACTER_CARD_REQUEST(3631),
    AUTH_HEARTBEAT(147),
    //
    APPLIED_HOT_FIX(152),
    WVS_SET_UP_STEP(154),
    ...
    B_E_G_I_N__U_S_E_R(1741),
    USER_TRANSFER_FIELD_REQUEST(66), //
    // USER_TRANSFER_FIELD_REQUEST(175), //
    //    USER_TRANSFER_CHANNEL_REQUEST(176),
    USER_TRANSFER_CHANNEL_REQUEST(67),//
    USER_MIGRATE_TO_CASH_SHOP_REQUEST(68),//
    USER_MIGRATE_TO_PVP_REQUEST(69), //
    ...
    USER_MELEE_ATTACK(77), //
    USER_SHOOT_ATTACK(78), //
    USER_MAGIC_ATTACK(79), //
    USER_BODY_ATTACK(80), //
    USER_AREA_DOT_ATTACK(81), //
    USER_MOVING_SHOOT_ATTACK_PREPARE(82), //?
    USER_HIT(83), //?
    USER_ATTACK_USER(202), // dunno this one ? pvp packets
    USER_CHAT(84), //
    USER_A_D_BOARD_CLOSE(85), //
    USER_EMOTION(86), //
    ANDROID_EMOTION(87),
    USER_ACTIVATE_EFFECT_ITEM(88),//
    USER_MONKEY_EFFECT_ITEM(89),//
    USER_ACTIVATE_NICK_ITEM(90), // guesses
    USER_ACTIVATE_DAMAGE_SKIN(21110),
    USER_ACTIVATE_DAMAGE_SKIN__PREMIUM(21111),
    USER_DAMAGE_SKIN_SAVE_REQUEST(21112),
    USER_DEFAULT_WING_ITEM(21113),
    USER_H_P(217),
    PREMIUM(218),
    USER_BAN_MAP_BY_MOB(219),
    USER_MONSTER_BOOK_SET_COVER(220),
    USER_SELECT_NPC(102),
    USER_REMOTE_SHOP_OPEN_REQUEST(103),
    USER_SCRIPT_MESSAGE_ANSWER(104), // Guess
    USER_SHOP_REQUEST(105),
    USER_TRUNK_REQUEST(104),
    USER_ENTRUSTED_SHOP_REQUEST(107),
    ...
    REQ_MAKING_SKILL_EFF(2134),
    SHOP_SCANNER_REQUEST(235),
    SHOP_LINK_REQUEST(236),
    ADMIN_SHOP_REQUEST(238),
    USER_SORT_ITEM_REQUEST(115), //

    USER_GATHER_ITEM_REQUEST(116),
    USER_CHANGE_SLOT_POSITION_REQUEST(117),
    ...
    USER_SCRIPT_ITEM_USE_REQUEST(121),
    USER_RECIPE_OPEN_ITEM_USE_REQUEST(253),
    USER_CONSUME_CASH_ITEM_USE_REQUEST(133), //
    ...
    USER_CHARACTER_INFO_REQUEST(22), //
    USER_ACTIVATE_PET_REQUEST(23), //
    USER_REGISTER_PET_AUTO_BUFF_REQUEST(313),
    USER_TEMPORARY_STAT_UPDATE_REQUEST(314),
    USER_PORTAL_SCRIPT_REQUEST(175), // ?
    USER_PORTAL_TELEPORT_REQUEST(176), // ?
    USER_MAP_PORTAL_REQUEST(177), // Inner portal
    USER_MAP_TRANSFER_REQUEST(318), //? Unsure
    ...
    USER_QUEST_REQUEST(184),
    USER_MEDAL_REISSUE_REQUEST(185),
    ...
    USER_SET_MOVE_GRENADE(33100),
    USER_MACRO_SYS_DATA_MODIFIED(332),
    USER_SELECT_NPC_ITEM_USE_REQUEST(33300),
    USER_LOTTERY_ITEM_USE_REQUEST(334000),
    USER_ROULETTE_START_REQUEST(335000),
    USER_ROULETTE_RESULT_REQUEST(336000),
    USER_ITEM_MAKE_REQUEST(337000),
    USER_REPAIR_DURABILITY_ALL(30038),
    USER_REPAIR_DURABILITY(30009),
    USER_QUEST_RECORD_SET_STATE(340000),
    USER_CLIENT_TIMER_END_REQUEST(30041),
    ...
    SET_PASSENGER_RESULT(3470),
    USER_REQUEST_INSTANCE_TABLE(3408),
    USER_REQUEST_CREATE_ITEM_POT(3409),
    USER_REQUEST_REMOVE_ITEM_POT(3500),
    USER_REQUEST_INC_ITEM_POT_LIFE_SATIETY(3051),
    USER_REQUEST_CURE_ITEM_POT_LIFE_SICK(352),
    USER_REQUEST_COMPLATE_TO_ITEM_POT(3530),
    USER_REQUEST_RESPAWN(3504),
    USER_CONSUME_HAIR_ITEM_USE_REQUEST(3550),
    USER_FORCE_ATOM_COLLISION(3560),
    ...
    USER_PROTECT_BUFF_DIE_ITEM_REQUEST(36311),
    ...
    MESSENGER(386333),
    MINI_ROOM(387333),
    PARTY_REQUEST(383338),
    PARTY_RESULT(383339),
    PARTY_INVITABLE_SET(228),
    EXPEDITION_REQUEST(229),
    EXPEDITION_LISTING(230),
    GUILD_REQUEST(231),
    GUILD_RESULT(232),
    ...
    QUICKSLOT_KEY_MAPPED_MODIFIED(320), //
    PASSIVESKILL_INFO_UPDATE(586),
    UPDATE_CLIENT_ENVIRONMENT(363), //
    ...
    MOB_HIT_BY_MOB(339), // ? uess
    MOB_SELF_DESTRUCT(340), // guiess
    ...
    B_E_G_I_N__D_R_O_P_P_O_O_L(-1),
    DROP_PICK_UP_REQUEST(356),
    E_N_D__D_R_O_P_P_O_O_L(-1),

    B_E_G_I_N__R_E_A_C_T_O_R_P_O_O_L(857),
    REACTOR_HIT(359),
    REACTOR_CLICK(360),
    REACTOR_RECT_IN_MOB(361),
    REACTOR_KEY(362),
