...
public enum InHeader {
    ...
    // Login ops
    BEGIN_SOCKET(0),
    CHECK_LOGIN_AUTH_INFO(1), // v92
    GUEST_LOGIN(2),

    SELECT_PREVIOUS_WORLD(4),
    SELECT_WORLD(5),

    WORLD_STATUS_REQUEST(6),
    TOS(7),
    WORLD_INFO_REQUEST(11),

    REDISPLAY_SERVERLIST(12),

    CHAR_SELECT_NO_PIC(19),
    MIGRATE_IN(20), // 20
    CHECK_DUPLICATE_ID(21),
    CREATE_NEW_CHARACTER(22),
    SERVERSTATUS_REQUEST(26), // v92
    // This one is with pic ?
    CHAR_SELECT(31),

    CLIENT_ERROR(38),  //is this 27..?
    CLIENT_START(36),
    VERSION_VERIFY(369), // client start
    ...
    USER_TRANSFER_FIELD_REQUEST(43), //
    USER_TRANSFER_CHANNEL_REQUEST(44),//
    USER_MIGRATE_TO_CASH_SHOP_REQUEST(45),//
    USER_MOVE(46), //
    USER_SIT_REQUEST(47), //
    USER_PORTABLE_CHAIR_SIT_REQUEST(48),
    USER_MELEE_ATTACK(49), //
    USER_SHOOT_ATTACK(50), //
    USER_MAGIC_ATTACK(51), //
    USER_BODY_ATTACK(52), //
    USER_HIT(53), //?
    USER_CHAT(55), // v92

    USER_A_D_BOARD_CLOSE(56), //
    USER_EMOTION(57), //
    USER_ACTIVATE_EFFECT_ITEM(58),//

    USER_UPGRADE_TOMB_EFFECT(59), //"deathitem" ?
    USER_H_P(60),
    PREMIUM(61),
    USER_BAN_MAP_BY_MOB(62),
    USER_MONSTER_BOOK_SET_COVER(63),
    USER_SELECT_NPC(64),
    USER_REMOTE_SHOP_OPEN_REQUEST(65),
    USER_SCRIPT_MESSAGE_ANSWER(66),
    USER_SHOP_REQUEST(67),
    USER_TRUNK_REQUEST(68),
    USER_ENTRUSTED_SHOP_REQUEST(69),
    USER_AREA_DOT_ATTACK(81), //
    USER_ACTIVATE_NICK_ITEM(90), // guesses
    USER_ACTIVATE_DAMAGE_SKIN(212310),
    USER_ACTIVATE_DAMAGE_SKIN__PREMIUM(212311),
    USER_DAMAGE_SKIN_SAVE_REQUEST(212123),
    USER_DEFAULT_WING_ITEM(213123),
    ...
    USER_POP_OR_PUSH_BAG_ITEM_TO_INVEN(212343),
    USER_POUR_IN_BAG_TO_BAG(212345),
    USER_STAT_CHANGE_ITEM_USE_REQUEST(241236),
    USER_STAT_CHANGE_ITEM_CANCEL_REQUEST(241237),
    USER_STAT_CHANGE_BY_PORTABLE_CHAIR_REQUEST(212348),
    USER_MOB_SUMMON_ITEM_USE_REQUEST(24123),
    USER_PET_FOOD_ITEM_USE_REQUEST(251230),
    ...
    USER_BRIDLE_ITEM_USE_REQUEST(2111160),
    USER_SKILL_LEARN_ITEM_USE_REQUEST(26134),
    USER_SKILL_RESET_ITEM_USE_REQUEST(262),
    USER_ABILITY_RESET_ITEM_USE_REQUEST(243463),
    USER_ABILITY_CHANGE_ITEM_USE_REQUEST(243464),
    USER_EXP_CONSUME_ITEM_USE_REQUEST(2643435),
    ...
    USER_CHARACTER_INFO_REQUEST(2200), //
    USER_ACTIVATE_PET_REQUEST(2300), //
    ...
    QUICKSLOT_KEY_MAPPED_MODIFIED(213), //
    ...
    CP_CANCEL_INVITE_PARTY_MATCH(260),
