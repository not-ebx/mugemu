package net.mugeemu.ms.handlers.item;
...
import net.mugeemu.ms.life.pet.PetSkill;
...
import static net.mugeemu.ms.enums.EquipBaseStat.tuc;
import static net.mugeemu.ms.enums.InvType.*;
import static net.mugeemu.ms.enums.InventoryOperation.*;
...
public class ItemHandler {
    ...
    public static void handleUserActivateNickItem(Client c, InPacket inPacket) {
        ...
        // TODO: Fixc this weird ass shit.
        //chr.getField().broadcastPacket(UserRemote.setActiveNickItem(charId, nickItem), chr);
    }
