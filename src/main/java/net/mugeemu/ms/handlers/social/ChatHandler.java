...
import net.mugeemu.ms.client.character.commands.*;
import net.mugeemu.ms.connection.InPacket;
import net.mugeemu.ms.connection.packet.ChatSocket;
...
import net.mugeemu.ms.client.character.commands.*;
import net.mugeemu.ms.enums.ChatUserType;
import net.mugeemu.ms.enums.GroupMessageType;
