...
*/
package net.mugeemu.ms.connection.crypto;
...
public final class MapleCrypto {
     ...
     *
     * @see MapleAES#checkPacket(byte[], byte[]) checking net.mugeemu.ms.connection.packet header using these.
     * @see MapleAES#checkPacket(int, byte[]) checking net.mugeemu.ms.connection.packet header using these.
    ...
    /**
     * Initializes the send and receive version values for net.mugeemu.ms.connection.packet
    ...
    /**
     * Creates a header for the new net.mugeemu.ms.connection.packet to be sent to the opposite
     * end of the session (Server to Channel for this engine). Contains
     * information about the net.mugeemu.ms.connection.packet: whether or not it is valid and the actual
     * length of the net.mugeemu.ms.connection.packet.
     *
     * @param delta the input net.mugeemu.ms.connection.packet length before adding the header.
     * @param gamma the input sending seed before changing it.
     *
     * @return the header to be sent with this net.mugeemu.ms.connection.packet.
     */
    ...
    /**
     * Gets the length of the net.mugeemu.ms.connection.packet given the received header.
     *
     * @param delta the net.mugeemu.ms.connection.packet header to be used to find the net.mugeemu.ms.connection.packet length.
     *
     * @return the length of the received net.mugeemu.ms.connection.packet.
     */
    ...
    /**
     * Checks the net.mugeemu.ms.connection.packet to make sure it is valid and that the session
     * between the net.mugeemu.ms.client and server is secure and legitimate.
     *
     * @param delta the net.mugeemu.ms.connection.packet header from the received net.mugeemu.ms.connection.packet (4 bytes in length).
     * @param gamma the current receive seed.
     *
     * @return whether or not the net.mugeemu.ms.connection.packet is valid (consequently, if not valid,
...
//        System.out.println("Delta[1] ^ gamma[3] = " + Integer.toBinaryString((delta[1] ^ gamma[3]) & 0xFF));
     ...
     * except that we convert the integer net.mugeemu.ms.connection.packet header (4 bytes combined)
     * into an array of the first 2 bytes of the integer net.mugeemu.ms.connection.packet header.
     ...
     * for the next net.mugeemu.ms.connection.packet sent or received.
     */
