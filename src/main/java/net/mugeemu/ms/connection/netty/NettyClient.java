 ...
 * for important resources used by the net.mugeemu.ms.client during encryption,
...
public class NettyClient {
    ...
    private byte[] riv;
    /**
     * Stored length used for net.mugeemu.ms.connection.packet decryption. This is used for
     * storing the net.mugeemu.ms.connection.packet length for the next net.mugeemu.ms.connection.packet that is readable.
     * Since TCP sessions ensure that all data arrives to the server in order,
     * we can decodeByte net.mugeemu.ms.connection.packet data in the correct order.
     */
    private int storedLength = -1;
    /**
     * Channel object associated with this specific net.mugeemu.ms.client. Used for all
     ...
     * @param c the channel object associated with this net.mugeemu.ms.client session.
     ...
     * @return a net.mugeemu.ms.connection.packet reader.
     */
    ...
    /**
     * Gets the stored length for the next net.mugeemu.ms.connection.packet to be read. Used as
     * a decoding state variable to determine when it is ok to proceed with
     * decoding a net.mugeemu.ms.connection.packet.
     * @return stored length for next net.mugeemu.ms.connection.packet.
     */
    ...
    /**
     * Sets the stored length for the next net.mugeemu.ms.connection.packet to be read.
     * @param val length of the next net.mugeemu.ms.connection.packet to be read.
     */
