package net.mugeemu.ms.connection;
...
public class OutPacket extends Packet {
     ...
     *
     * @param data The data this net.mugeemu.ms.connection.packet has to be initialized with.
     */
    ...
    public void concat(OutPacket concatPacket) {
        this.encodeArr(concatPacket.getData());
    }
}
