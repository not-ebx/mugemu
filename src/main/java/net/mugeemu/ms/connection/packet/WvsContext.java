...
import net.mugeemu.ms.client.character.info.ExpIncreaseInfo;
import net.mugeemu.ms.client.character.info.ZeroInfo;
import net.mugeemu.ms.client.character.items.Equip;
import net.mugeemu.ms.client.character.items.Item;
import net.mugeemu.ms.client.character.items.MemorialCubeInfo;
...
import net.mugeemu.ms.client.friend.result.FriendResult;
import net.mugeemu.ms.client.guild.Guild;
import net.mugeemu.ms.client.guild.bbs.GuildBBSPacket;
...
import net.mugeemu.ms.util.AntiMacro;
...
import static net.mugeemu.ms.enums.MessageType.*;
...
//        temporaryStatManager.getRemovedStats().forEach((cts, option) -> outPacket.encodeInt(0));
    ...
    /**
     * Returns a net.mugeemu.ms.connection.packet for messages with the following {@link MessageType}:<br>
