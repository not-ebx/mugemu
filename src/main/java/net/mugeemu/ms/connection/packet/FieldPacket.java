...
import net.mugeemu.ms.client.character.MarriageRecord;
...
import net.mugeemu.ms.util.container.Triple;
import net.mugeemu.ms.world.field.ClockPacket;
...
public class FieldPacket {
    ...
    // I think this is teleport to map or teleport normal?
    ...
    public static OutPacket teleport(Portal portal, Char chr) {
        OutPacket outPacket = new OutPacket(OutHeader.TELEPORT);

        outPacket.encodeByte(0);
        outPacket.encodeByte(portal.getId());
