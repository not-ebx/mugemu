...
import net.mugeemu.ms.client.jobs.resistance.Blaster;
...
import net.mugeemu.ms.enums.TextEffectType;
import net.mugeemu.ms.enums.UserEffectType;
...
import static net.mugeemu.ms.enums.UserEffectType.*;
