package net.mugeemu.ms.constants;
...
import net.mugeemu.ms.client.jobs.cygnus.DawnWarrior;
import net.mugeemu.ms.client.jobs.cygnus.NightWalker;
import net.mugeemu.ms.client.jobs.cygnus.ThunderBreaker;
...
import net.mugeemu.ms.client.jobs.resistance.Mechanic;
import net.mugeemu.ms.enums.BeastTamerBeasts;
import net.mugeemu.ms.loaders.SkillData;
import org.apache.log4j.Logger;

import java.util.*;

import static net.mugeemu.ms.client.jobs.legend.Aran.*;
import static net.mugeemu.ms.client.jobs.legend.Mercedes.STAGGERING_STRIKES;
import static net.mugeemu.ms.client.jobs.legend.Mercedes.STUNNING_STRIKES;
import static net.mugeemu.ms.client.jobs.nova.AngelicBuster.*;
import static net.mugeemu.ms.client.jobs.nova.Kaiser.*;
import static net.mugeemu.ms.client.jobs.resistance.Blaster.*;
