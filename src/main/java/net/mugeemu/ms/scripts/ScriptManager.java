...
import net.mugeemu.ms.world.field.Clock;
...
public interface ScriptManager extends Observer {
	 ...
	 *
	 * @param type type of action used. refer to: {@link ForcedInputType}
	 */
	 ...
	 * Add from net.mugeemu.ms.enums import UIType at the top of the npc script to use this.
