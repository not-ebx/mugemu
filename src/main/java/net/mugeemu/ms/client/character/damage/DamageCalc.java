package net.mugeemu.ms.client.character.damage;
...
import static net.mugeemu.ms.enums.BaseStat.*;
...
public class DamageCalc {
    ...
    public long calcPDamageForPvM(int skillID, byte slv) {
        ...
        int setBaseDamage = tsm.hasStat(CharacterTemporaryStat.SetBaseDamage) ? tsm.getOption(CharacterTemporaryStat.SetBaseDamage).nOption : 0;
