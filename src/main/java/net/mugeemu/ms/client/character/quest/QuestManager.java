package net.mugeemu.ms.client.character.quest;

import net.mugeemu.ms.client.character.quest.requirement.QuestStartCompletionRequirement;
import net.mugeemu.ms.client.character.quest.requirement.QuestStartRequirement;
import net.mugeemu.ms.client.character.quest.reward.QuestBuffItemReward;
import net.mugeemu.ms.client.character.quest.reward.QuestItemReward;
import net.mugeemu.ms.client.character.quest.reward.QuestReward;
...
import static net.mugeemu.ms.enums.QuestStatus.*;
    ...
    private void addQuest(Quest quest, boolean addRewardsFromWz) {
        if(!getQuests().containsKey(quest.getQRKey())) {
            ...
            if(quest.getStatus() == QuestStatus.Completed) {
                chr.chatMessage(Normal, "[Info] Completed quest " + quest.getQRKey());
            } else {
                chr.chatMessage(Normal, "[Info] Accepted quest " + quest.getQRKey());
                if(addRewardsFromWz) {
