...
public class Equip extends Item {
    ...
    public void encode(OutPacket outPacket) {
        ...
        outPacket.encodeByte(getLevel()); // CUCK!!!!!
    ...
    public static Equip build(int itemId) {
        Equip eq = new Equip();
        eq.itemId = itemId;
        return eq;
    }

    public Equip setValue(String key, String value) {
        ...
        switch (key) {
            case "name":
                ...
                break;
            case "incMHP":
                this.iMaxHp = Short.parseShort(value);
                break;
            case "incMMP":
                this.iMaxMp = Short.parseShort(value);
                break;
            case "incMMPr":
                //this.incMpRec = Integer.parseInt(value);
                break;
            case "incMHPr":
                //this.incHpRec = Integer.parseInt(value);
                break;
            case "incSTR":
                this.iStr = Short.parseShort(value);
                break;
            case "incDEX":
                this.iDex = Short.parseShort(value);
                break;
            case "incINT":
                this.iInt = Short.parseShort(value);
                break;
            case "incLUK":
                this.iLuk = Short.parseShort(value);
                break;
            case "incMDD":
                this.iMDD = Short.parseShort(value);
                break;
            case "incPDD":
                this.iPDD = Short.parseShort(value);
                break;
            case "incPAD":
                this.iPad = Short.parseShort(value);
                break;
            case "incMAD":
                this.iMad = Short.parseShort(value);
                break;
            case "incACC":
                this.iAcc = Short.parseShort(value);
                break;
            case "incEVA":
                this.iEva = Short.parseShort(value);
                break;
            case "incSpeed":
                this.iSpeed = Short.parseShort(value);
                break;
            case "incJump":
                this.iJump = Short.parseShort(value);
                break;
            case "islot": //& "vslot"
                this.iSlot = value;
                break;
            case "price":
                ...
                break;
            case "reqSTR":
                this.rStr = Short.parseShort(value);
                break;
            case "reqDEX":
                this.rDex = Short.parseShort(value);
                break;
            case "reqINT":
                this.rInt = Short.parseShort(value);
                break;
            case "reqLUK":
                this.rLuk = Short.parseShort(value);
                break;
            case "reqPOP":
                this.rPop = Short.parseShort(value);
                break;
            case "reqLevel":
                this.rLevel = Short.parseShort(value);
                break;
            case "reqJob":
                this.rJob = Short.parseShort(value);
                break;
            case "tuc":
                this.tuc = Short.parseShort(value);
                break;
            case "attackSpeed":
                this.attackSpeed = Short.parseShort(value);
                break;
            case "knockback":
                //this.knockback = Short.parseShort(value);
                break;
            case "durability":
                this.durability = Short.parseShort(value);
                break;
            // Equipment only flags.
            case "equipTradeBlock":
                this.equipTradeBlock = Short.parseShort(value) == 1;
                break;
            case "epicItem":
                //this.epicItem = Boolean.parseBoolean(value);
                break;
            case "notExtend":
                //this.notExtend = Boolean.parseBoolean(value);
                break;
            case "pickupMeso":
            case "pickupItem":
            case "sweepForDrop":
            ...
            case "consumeMP":
            case "consumeHP":
            case "tradeAvailable": // Idk what to....
                break;
            // Item Flags, shared with regular items
            case "tradBlock":
            case "tradeBlock":
                this.tradeBlock = Short.parseShort(value) == 1;
                break;
            case "cash":
                this.isCash = Short.parseShort(value) == 1;
            case "only":
                this.only = Short.parseShort(value) == 1;
            case "quest":
            case "expireOnLogout":
                this.expireOnLogout = Short.parseShort(value) == 1;
            case "timeLimited":
            case "notSale":
                this.notSale = Short.parseShort(value) == 1;
