...
import net.mugeemu.ms.client.character.skills.*;
...
import net.mugeemu.ms.client.character.skills.GuidedBullet;
import net.mugeemu.ms.client.character.skills.*;
import net.mugeemu.ms.client.character.skills.PartyBooster;
...
public class Pirate extends Beginner {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            case DASH:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.Speed, o1);
            ...
            case GALACTIC_MIGHT:
                ...
                break;
            case TIME_LEAP:
                long nextAvailableTime = System.currentTimeMillis() + (si.getValue(SkillStat.time, slv)*1000);
            ...
            case SPEED_INFUSION:
                ...
                pb.setExpireTerm(1);
                tsm.putCharacterStatValue(CharacterTemporaryStat.PartyBooster, pb.getOption());
                break;
            case INFINITY_BLAST:
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.NoBulletConsume, o1);
                break;
            ...
            case LUCK_OF_THE_DIE:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.Dice, o1);
            ...
            case LUCK_OF_THE_DIE_DD:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.Dice, o1);
                if(isCharged) {
                    updateViperEnergy(tsm.getOption(CharacterTemporaryStat.EnergyCharged).nOption);
                }
                chr.reduceSkillCoolTime(NAUTILUS_STRIKE_SAIR, (long) (chr.getRemainingCoolTime(NAUTILUS_STRIKE_SAIR) * 0.5F));
                chr.reduceSkillCoolTime(NAUTILUS_STRIKE_CANNON, (long) (chr.getRemainingCoolTime(NAUTILUS_STRIKE_CANNON) * 0.5F));
                break;
            ...
            case MEGA_MONKEY_MAGIC:
                ...
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieACC, o1);
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indieAllStat, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieAllStat, o2);
                o3.nReason = skillID;
                o3.nValue = si.getValue(SkillStat.indieEva, slv);
                o3.tStart = (int) System.currentTimeMillis();
                o3.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieEVA, o3);
                o4.nReason = skillID;
                o4.nValue = si.getValue(SkillStat.indieJump, slv);
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieJump, o4);
                o5.nReason = skillID;
                o5.nValue = si.getValue(SkillStat.indieMhp, slv);
                o5.tStart = (int) System.currentTimeMillis();
                o5.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMHP, o5);
                o6.nReason = skillID;
                o6.nValue = si.getValue(SkillStat.indieMmp, slv);
                o6.tStart = (int) System.currentTimeMillis();
                o6.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMMP, o6);
                o7.nReason = skillID;
                o7.nValue = si.getValue(SkillStat.indieSpeed, slv);
                o7.tStart = (int) System.currentTimeMillis();
                o7.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieSpeed, o7);
                break;
            case BARREL_ROULETTE:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Roulette, o1);
                giveBarrelRouletteBuff(roulette);
                chr.reduceSkillCoolTime(NAUTILUS_STRIKE_CANNON, (long) (chr.getRemainingCoolTime(NAUTILUS_STRIKE_CANNON) * 0.5F));
                break;
            case BOUNTY_CHASER:
                o1.nOption = si.getValue(SkillStat.dexX, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DEX, o1);
                o2.nOption = si.getValue(SkillStat.strX, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.STR, o2);
                o3.nReason = skillID;
                ...
                o4.nReason = skillID;
                o4.nValue = si.getValue(SkillStat.indieDamR, slv);
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o4);
                break;
            case SLIPSTREAM_SUIT:
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DEXR, o1);
                o2.nOption = si.getValue(SkillStat.y, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVAR, o2);
                o3.nOption = si.getValue(SkillStat.y, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.ACCR, o3);
                break;
            case QUICKDRAW:
                o1.nOption = 2;
                o1.rOption = skillID;
                o1.tOption = 10;
                tsm.putCharacterStatValue(CharacterTemporaryStat.QuickDraw, o1);
            ...
            case PIRATE_SPIRIT:
                ...
                break;
            case JOLLY_ROGER:
                o1.nOption = si.getValue(SkillStat.eva, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVA, o1);
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indiePadR, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePADR, o2);
                o3.nOption = si.getValue(SkillStat.z, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.AsrR, o4);
                o5.nOption = si.getValue(SkillStat.x, slv);
                o5.rOption = skillID;
                o5.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.TerR, o5);
                break;
            case CROSSBONES:
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indiePadR, slv);
            ...
            case STIMULATING_CONVERSATION:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Stimulate, o1);
                o2.nOption = si.getValue(SkillStat.indieDamR, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamR, o2);
            ...
            case WHALERS_POTION:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indieMhpR, slv);
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                ...
                o3.nOption = si.getValue(SkillStat.w, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamageReduce, o3);
                break;
            ...
            case BUCKSHOT:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.BuckShot, o1);
                break;
        ...
        if(chr.hasSkill(AHOY_MATEYS)) {
            ...
            switch (random) {
                case 5210015:
                    ...
                    o1.tOption = 120;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IncCriticalDamMin, o1);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IncCriticalDamMax, o1);
                    break;
                case 5210016:
                    o1.nOption = si.getValue(SkillStat.s, slv);
                    o1.rOption = skill.getSkillId();
                    o1.tOption = 120;
                ...
                case 5210017:
                    ...
                    o1.tOption = 120;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMHPR, o1);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMMPR, o1);
    ...
    private void powerUnity() {
        ...
        SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
        int amount = 1;
        if(tsm.hasStat(CharacterTemporaryStat.UnityOfPower)) {
            amount = tsm.getOption(CharacterTemporaryStat.UnityOfPower).nOption;
            if(amount < 4) {
                amount++;
            }
        }
        ...
        o1.rOption = skill.getSkillId();
        o1.tOption = si.getValue(SkillStat.time, slv);
        tsm.putCharacterStatValue(CharacterTemporaryStat.UnityOfPower, o1);
        tsm.sendSetStatPacket();
    }
    ...
    private void incrementStimulatingConversation() {
        ...
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if (tsm.hasStat(CharacterTemporaryStat.Stimulate)) {
            Skill skill = chr.getSkill(STIMULATING_CONVERSATION);
            byte slv = (byte) skill.getCurrentLevel();
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            updateViperEnergy(tsm.getOption(CharacterTemporaryStat.EnergyCharged).nOption + si.getValue(SkillStat.x, slv));
    ...
    private void giveBarrelRouletteBuff(int roulette) {   //TODO
        ...
        switch (roulette) {
            case 1: // Extra Attack (Final Attack)
                ...
                break;
            case 2: // Max CritDmg
                o.nOption = si.getValue(SkillStat.s, slv);
                o.rOption = 0;
                o.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IncCriticalDamMin, o);
                tsm.sendSetStatPacket();
                break;
            case 3: // Slow Debuff
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        if (JobConstants.isCannonShooter(chr.getJob())) {
            if(hasHitMobs) {
                ...
                if(chr.hasSkill(MONKEY_WAVE)) {
                    ...
                    if (Util.succeedProp(mwsi.getValue(SkillStat.w, mwslv)) && !(tsm.getOption(CharacterTemporaryStat.KeyDownTimeIgnore).nOption > 0) && attackInfo.skillId != 5310008) {
                        o1.nOption = 1;
                        o1.rOption = 5310008;
                        o1.tOption = 15; // doesn't have an assigned skillStat
                        tsm.putCharacterStatValue(CharacterTemporaryStat.KeyDownTimeIgnore, o1);
                        tsm.sendSetStatPacket();
                    }
                }
            }
        ...
        switch (attackInfo.skillId) {
            ...
            case MONKEY_WAVE:
                ...
                if(tsm.hasStat(CharacterTemporaryStat.KeyDownTimeIgnore) && tsm.getOption(CharacterTemporaryStat.KeyDownTimeIgnore).nOption > 0) {
                    tsm.removeStatsBySkill(5310008);
                    tsm.removeStat(CharacterTemporaryStat.KeyDownTimeIgnore, true);
                    tsm.sendResetStatPacket();
                }
                o2.nOption = si.getValue(SkillStat.x, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.subTime, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IncCriticalDamMax, o2);
                tsm.sendSetStatPacket();
                break;
            case STARLINE_TWO:
                for(MobAttackInfo mai : attackInfo.mobAttackInfo) {
                    if (Util.succeedProp(si.getValue(SkillStat.hcProp, slv))) {
                        Mob mob = (Mob) chr.getField().getLifeByObjectID(mai.mobId);
                        if (mob == null) {
                            continue;
                        }
                        if(!mob.isBoss()) {
                            ...
                            o1.nOption = 1;
                            o1.rOption = skill.getSkillId();
                            o1.tOption = si.getValue(SkillStat.hcTime, slv);
                            mts.addStatOptionsAndBroadcast(MobStat.Stun, o1);
                        }
                    }
                }
            ...
            case PARROTARGETTING:
                for(MobAttackInfo mai : attackInfo.mobAttackInfo) {
                    ...
                    tsm.putCharacterStatValue(CharacterTemporaryStat.GuidedBullet, gb.getOption());
                    tsm.sendSetStatPacket();
                }
                break;
            case DRAGON_STRIKE:
            ...
            case NAUTILUS_STRIKE_BUCC:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.VenomSnake, o1);
                tsm.sendSetStatPacket();
                break;
        }
    ...
    private void activateQuickdraw(AttackInfo attackInfo, TemporaryStatManager tsm) {
        ...
        if (tsm.getOption(CharacterTemporaryStat.QuickDraw).nOption == 2) {
            if(hasHitMobs) {
                tsm.removeStatsBySkill(QUICKDRAW);
            }
        } else {
            if (Util.succeedProp(quickdrawInfo.getValue(SkillStat.prop, quickdrawInfo.getCurrentLevel()))) {
                o.nOption = 1;
                o.rOption = QUICKDRAW;
                tsm.putCharacterStatValue(CharacterTemporaryStat.QuickDraw, o);
                tsm.sendSetStatPacket();
            }
        }
    }
    ...
    private void applyStunMasteryOnMob(AttackInfo attackInfo) {
        ...
        for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
            if (Util.succeedProp(si.getValue(SkillStat.subProp, slv))) {
                Mob mob = (Mob) chr.getField().getLifeByObjectID(mai.mobId);
                if (mob == null) {
                    continue;
                }
    ...
    private void changeViperEnergy(int skillId) {
        ...
        if(tsm.getViperEnergyCharge() == 0) {
            if (tsm.hasStat(CharacterTemporaryStat.EnergyCharged)) {
                energy = tsm.getOption(CharacterTemporaryStat.EnergyCharged).nOption;
    ...
    private int deductViperEnergyCost(int skillId) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        int energy = tsm.getOption(CharacterTemporaryStat.EnergyCharged).nOption;
        SkillInfo si = SkillData.getSkillInfoById(skillId);
        energy = energy - si.getValue(SkillStat.forceCon, 1);
    ...
    private void updateViperEnergy(int energy) {
        ...
        tsb.setROption(0);
        tsm.putCharacterStatValue(CharacterTemporaryStat.EnergyCharged, tsb.getOption());
        if(energy >= getMaximumEnergy()) {
    ...
    private int getEnergyIncrement() {
        ...
        return si.getValue(SkillStat.x, slv);
    }
    ...
    private void applyBarrelRouletteDebuffOnMob(AttackInfo attackInfo) {
        if(chr.hasSkill(BARREL_ROULETTE)) {
            ...
            byte slv = (byte) skill.getCurrentLevel();
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            if(tsm.hasStat(CharacterTemporaryStat.Roulette)) {
                for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
                    Mob mob = (Mob) chr.getField().getLifeByObjectID(mai.mobId);
                    if (mob == null) {
                        continue;
                    ...
                    MobTemporaryStat mts = mob.getTemporaryStat();
                    if (tsm.hasStat(CharacterTemporaryStat.Roulette) && tsm.getOption(CharacterTemporaryStat.Roulette).nOption == 4) {  //DoT Debuff
                        mts.createAndAddBurnedInfo(chr, skill);
                    } else if (tsm.hasStat(CharacterTemporaryStat.Roulette) && tsm.getOption(CharacterTemporaryStat.Roulette).nOption == 3) {  //Slow Debuff
                        int slowProc = si.getValue(SkillStat.w, slv);
                        if (Util.succeedProp(slowProc)) {
                            o.nOption = -20;
                            o.rOption = skill.getSkillId();
                            o.tOption = si.getValue(SkillStat.v, slv);
    ...
    public int getFinalAttackSkill() {
        ...
        if(tsm.hasStat(CharacterTemporaryStat.Roulette) && tsm.getOption(CharacterTemporaryStat.Roulette).nOption == 1 && Util.succeedProp(si.getValue(
            SkillStat.z, chr.getSkill(BARREL_ROULETTE).getCurrentLevel()))) {
            return 5310008;
        }
