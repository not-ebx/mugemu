package net.mugeemu.ms.client.jobs.sengoku;
...
public class Hayato extends Job {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            case QUICK_DRAW:
                if(tsm.getOption(CharacterTemporaryStat.HayatoStance).nOption == 0) {
                    if(swordEnergy < 150) {
                ...
                if(tsm.getOption(CharacterTemporaryStat.HayatoStance).nOption == 1) {
                    resetQuickDrawStanceBonus();
                }
                o1.nOption = 1;
                o1.rOption = skillID;
                tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoStance, o1);
            ...
            case BATTOUJUTSU_ADVANCE:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.BattoujutsuAdvance, o1);
                o2.nOption = 8;
                o2.rOption = skillID;
            ...
            case MILITARY_MIGHT:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMHPR, o1); //Indie
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.y, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMMPR, o1); //Indie
                o3.nOption = si.getValue(SkillStat.speed, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Speed, o3);
                o4.nOption = si.getValue(SkillStat.jump, slv);
                o4.rOption = skillID;
                o4.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Jump, o4);
                o5.nOption = si.getValue(SkillStat.padX, slv);
                o5.rOption = skillID;
            ...
            case IRON_SKIN:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.TerR, o1);
                break;
            ...
            case EYE_FOR_AN_EYE:
                if(tsm.hasStatBySkillId(skillID)) {
                    ...
                    o1.nOption = 1;
                    o1.rOption = skillID;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.EyeForEye, o1);
                }
                break;
            case PRINCESS_VOW_HAYATO:
                ...
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indieMaxDamageOver, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMaxDamageOver, o2);
                break;
            case GOD_OF_BLADES:
                o1.nReason = skillID;
    ...
    public void changeHayatoStanceBonus() {
        ...
        Option o = new Option();
        o.nOption = 1;
        o.rOption = tsm.getOption(CharacterTemporaryStat.HayatoStance).nOption == 0 ? NORMAL_STANCE_BONUS : QUICK_DRAW_STANCE_BONUS;
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoStanceBonus, o);
        tsm.sendSetStatPacket();
    }
    ...
    private void quickDrawStanceBonus() {
        ...
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoBoss, o1);

        //Crit Rate
        o2.nOption = hayatoCrit;
        o2.rOption = QUICK_DRAW_STANCE_BONUS;
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoCr, o2);

        //Booster
        o3.nOption = hayatoBooster;
        o3.rOption = QUICK_DRAW_STANCE_BONUS;
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoBooster, o3);
    }
    ...
    private void normalStanceBonus() {
        ...
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoPAD, o1);

        //MHP
        //MMP
        o2.nOption = hayatoMHPR;
        o2.rOption = NORMAL_STANCE_BONUS;
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoHPR, o2);
        tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoMPR, o2);

        //IED
        o3.nOption = hayatoIED;
        o3.rOption = NORMAL_STANCE_BONUS;
        tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreTargetDEF, o3);
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        switch (attackInfo.skillId) {
            ...
            case HITOKIRI_HUNDRED_STRIKE:
                if((tsm.getOptByCTSAndSkill(CharacterTemporaryStat.IndieDamR, SUMMER_RAIN) == null) || (tsm.getOptByCTSAndSkill(
                    CharacterTemporaryStat.IndieDamR, HITOKIRI_HUNDRED_STRIKE) == null)) {
                    o1.nReason = skillID;
                    o1.nValue = 15;
                    o1.tStart = (int) System.currentTimeMillis();
                    o1.tTerm = 120;
            ...
            case HITOKIRI_STRIKE:
                if(tsm.getOptByCTSAndSkill(CharacterTemporaryStat.IndieCr, HITOKIRI_STRIKE) == null) {
                    o1.nReason = skillID;
                    o1.nValue = si.getValue(SkillStat.prop, slv);
                    o1.tStart = (int) System.currentTimeMillis();
                    o1.tTerm = si.getValue(SkillStat.time, slv);
    ...
    public void warriorHeartHealHP(AttackInfo attackInfo) { //TODO on Crit hit,  proc% to gainHP%
        if(chr.hasSkill(WARRIOR_HEART)) {
            ...
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            int proc = si.getValue(SkillStat.prop, slv);
            int healrate = si.getValue(SkillStat.x, slv);
    ...
    public void incrementSwordEnergy(AttackInfo attackInfo) {
        ...
        for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
            ...
            if(totaldmg >= mob.getHp()) {
                ...
                } else if (tsm.getOption(CharacterTemporaryStat.HayatoStance).nOption == 1) {
    ...
    public void incrementWillowDodge() {   //TODO
        ...
        Option o1 = new Option();
        int amount = 3;
        if (tsm.hasStat(CharacterTemporaryStat.WillowDodge)) {
            amount = tsm.getOption(CharacterTemporaryStat.WillowDodge).nOption;
            if (amount < 5) {
                amount++;
            }
        }
        ...
        o.tOption = 20;
        tsm.putCharacterStatValue(CharacterTemporaryStat.WillowDodge, o);
        o1.nOption = si.getValue(SkillStat.damR, slv);
    ...
    public void jinsoku() {
        ...
        if(chr.hasSkill(JINSOKU)) {
            ...
            byte slv = (byte) skill.getCurrentLevel();
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            int proc = si.getValue(SkillStat.t, slv);
            if(Util.succeedProp(proc)) {
                o.nOption = si.getValue(SkillStat.y, slv);
                o.rOption = skill.getSkillId();
                o.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamageReduce, o);
                tsm.sendSetStatPacket();
            }
        }
    }
