...
public class BattleMage extends Citizen {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case HASTY_AURA:
                ...
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indieSpeed, slv);
            ...
            case BLUE_AURA:
                ...
                o3.rOption = skillID;
                o3.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreMobDamR, o3);
                o3.nOption = 1;
                o3.rOption = skillID;
                o3.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.BMageAura, o3);
            ...
            case BATTLE_RAGE:
                ...
                o4.rOption = skillID;
                o4.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IncCriticalDamMin, o4);
                break;
    ...
    public void applyBlueAuraDispel() {
        ...
        if (chr.hasSkill(32120062)) { //Blue Aura - Dispel Magic
            if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.BMageAura, skill.getSkillId()) != null) {
    ...
    private int doCondemnationAttack(int killCount) {
        ...
        if(lastCondemnationAttack + (getCondemnationCooldown() * 1000) < System.currentTimeMillis()) {
            ...
            death = tsm.getOption(CharacterTemporaryStat.IndieEmpty).summon;
    ...
    private int getCondemnationCooldown() {
        ...
        return si.getValue(SkillStat.time, 1);
    }
    ...
    private int getCondemnationKillReq() {
        ...
        return si.getValue(SkillStat.x, 1);
    }
    ...
    private void drainAuraActiveHPRecovery(AttackInfo attackInfo) {
        ...
        SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
        int duration = 1000 * si.getValue(SkillStat.subTime, slv);
        if ((tsm.getOptByCTSAndSkill(CharacterTemporaryStat.BMageAura, DRAINING_AURA) != null) && (drainAuraCD + duration < System.currentTimeMillis())) {
            for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
                drainAuraCD = System.currentTimeMillis();
                int totaldmg = Arrays.stream(mai.damages).sum();
                int healingrate = si.getValue(SkillStat.x, slv);
    ...
    public void applyWeakenAuraOnMob() {
        ...
        SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
        Option o = new Option();
        int delay = si.getValue(SkillStat.y, slv);
        if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.BMageAura, skill.getSkillId()) != null) {
