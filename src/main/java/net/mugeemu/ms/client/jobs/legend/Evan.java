...
public class Evan extends Job {
    ...
    public void givePartnersBuff(int skillID) {
        ...
        Option o = new Option();
        Option o1 = new Option();
        if(tsm.getOptByCTSAndSkill(CharacterTemporaryStat.Stance, PARTNERS) == null) {
            prevSkill = skillID;
            o.nReason = PARTNERS;
            o.nValue = si.getValue(SkillStat.indieDamR, 1);
            o.tStart = (int) System.currentTimeMillis();
            o.tTerm = 3;
            tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o);
            o1.nOption = si.getValue(SkillStat.stanceProp, 1);
            o1.rOption = PARTNERS;
            o1.tOption = 3;
                ...
                case RETURN_FLASH:
                    ...
                    for(Life life : chr.getField().getLifesInRect(rect)) {
                        if(life instanceof Mob && ((Mob) life).getHp() > 0) {
                            ...
                            o1.nOption = rflash.getValue(SkillStat.x, slv);
                            o1.rOption = skillID;
                            o1.tOption = rflash.getValue(SkillStat.time, slv);
