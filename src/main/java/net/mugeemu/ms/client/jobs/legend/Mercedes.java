...
public class Mercedes extends Job {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case IGNIS_ROAR:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IgnisRore, o1);
            ...
            case WATER_SHIELD:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamAbsorbShield, o3);   //IgnoreMobDamR
                break;
            case ANCIENT_WARDING:
                o1.nOption = si.getValue(SkillStat.emhp, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EMHP, o1);
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        switch (attackInfo.skillId) {
            case STUNNING_STRIKES:
                ...
                int proc = stunningStrikes.getValue(SkillStat.prop, slv);
            ...
            case STAGGERING_STRIKES:
                ...
                int procc = staggeringStrikes.getValue(SkillStat.prop, slv);
                for(MobAttackInfo mai : attackInfo.mobAttackInfo) {
    ...
    private void incrementIgnisRoarStackCount(TemporaryStatManager tsm, AttackInfo attackInfo) {
        ...
        if (tsm.hasStat(CharacterTemporaryStat.IgnisRore)) {
            if (tsm.hasStat(CharacterTemporaryStat.AddAttackCount)) {
                amount = tsm.getOption(CharacterTemporaryStat.AddAttackCount).nOption;
                if (amount < ignisRoarInfo.getValue(SkillStat.y, slv)) {
                    amount++;
                }
            }
            ...
            o.tOption = ignisRoarInfo.getValue(SkillStat.subTime, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.AddAttackCount, o);
            o1.nOption = (amount * ignisRoarInfo.getValue(SkillStat.x, slv));
            o1.rOption = IGNIS_ROAR;
            o1.tOption = ignisRoarInfo.getValue(SkillStat.subTime, slv);
