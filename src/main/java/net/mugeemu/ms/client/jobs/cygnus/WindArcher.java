...
public class WindArcher extends Noblesse {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case SYLVAN_AID:
                ...
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePAD, o1); //Indie
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.SoulArrow, o3);
                break;
            case ALBATROSS:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indieBooster, slv);
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieBooster, o1); //Indie
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indieCr, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieCr, o2); //Indie
                o3.nReason = skillID;
                o3.nValue = si.getValue(SkillStat.indieMhp, slv);
                o3.tStart = (int) System.currentTimeMillis();
                o3.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMHP, o3); //Indie
                o4.nReason = skillID;
                o4.nValue = si.getValue(SkillStat.indiePad, slv);
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePAD, o4); //Indie
                break;
            case ALBATROSS_MAX:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indiePad, slv);
                ...
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o2); //Indie
                o3.nReason = skillID;
                o3.nValue = si.getValue(SkillStat.indieCr, slv);
                o3.tStart = (int) System.currentTimeMillis();
                o3.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieCr, o3); //Indie
                o4.nReason = skillID;
                o4.nValue = si.getValue(SkillStat.indieAsrR, slv);
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieAsrR, o4); //Indie
                o5.nReason = skillID;
                o5.nValue = si.getValue(SkillStat.indieAsrR, slv);
                o5.tStart = (int) System.currentTimeMillis();
                o5.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieTerR, o5); //Indie
                o6.nReason = skillID;
                o6.nValue = -2; //si.getValue(indieBooster, slv);
                o6.tStart = (int) System.currentTimeMillis();
                o6.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieBooster, o6); //Indie
                o7.nOption = si.getValue(SkillStat.ignoreMobpdpR, slv);
                o7.rOption = skillID;
                o7.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreMobpdpR, o7);
                break;
            ...
            case TOUCH_OF_THE_WIND: // x = Dex%   avoid/acc = y
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indiePadR, slv);
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePADR, o1); //Indie
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indieMhpR, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMHPR, o2); //Indie
                o3.nOption = si.getValue(SkillStat.x, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DEXR, o3);
                o4.nOption = si.getValue(SkillStat.y, slv);
                o4.rOption = skillID;
                o4.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.ACCR, o4);
                o5.nOption = si.getValue(SkillStat.y, slv);
                o5.rOption = skillID;
                o5.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVAR, o5);
                break;
            ...
            case STORM_BRINGER:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.StormBringer, o1);
                break;
        }
    ...
    private void createStormBringerForceAtom(AttackInfo attackInfo) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if (tsm.hasStat(CharacterTemporaryStat.StormBringer)) {
            ...
            for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
                ...
                int hyperprop = si.getValue(SkillStat.prop, 1);
    ...
    private int getTriflingWindSubProp() {
        ...
        if(skill != null) {
            ...
            return si.getValue(SkillStat.subProp, slv);
        }
        return 0;
    }
    ...
    public void applyEmeraldFlowerDebuffToMob(Summon summon, int mobTemplateId) {
        ...
        for(Mob mob : mobListWithTemplateId) {
            MobTemporaryStat mts = mob.getTemporaryStat();
            Option o = new Option();
            o.nOption = si.getValue(SkillStat.z, slv);
    ...
    public void applyEmeraldDustDebuffToMob(Summon summon, int mobTemplateId) {
        ...
        for(Mob mob : mobListWithTemplateId) {
            MobTemporaryStat mts = mob.getTemporaryStat();
            Option o = new Option();
            o.nOption = si.getValue(SkillStat.w, slv);
            o.rOption = skill.getSkillId();
            o.tOption = si.getValue(SkillStat.time, slv);
    ...
    public void handleHit(Client c, InPacket inPacket, HitInfo hitInfo) {
        ...
        if(chr.hasSkill(SECOND_WIND)) {
            if(hitInfo.hpDamage == 0 && hitInfo.mpDamage == 0) {
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePAD, o3);
                tsm.sendSetStatPacket();
            }
        }
