...
import net.mugeemu.ms.client.character.skills.TownPortal;
import net.mugeemu.ms.client.character.skills.info.AttackInfo;
import net.mugeemu.ms.client.character.skills.info.ForceAtomInfo;
...
import net.mugeemu.ms.enums.ForceAtomEnum;
import net.mugeemu.ms.enums.LeaveType;
import net.mugeemu.ms.enums.MoveAbility;
import net.mugeemu.ms.enums.Stat;
import net.mugeemu.ms.handlers.EventManager;
import net.mugeemu.ms.loaders.FieldData;
...
public class Magician extends Beginner {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            case MAGIC_GUARD:
                ...
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.MagicGuard, o1);
                break;
            ...
            case MEDITATION_FP:
            case MEDITATION_IL:
                o1.nValue = si.getValue(SkillStat.indieMad, slv);
                o1.nReason = skillID;
                ...
                break;
            case IGNITE:
                if (tsm.hasStat(CharacterTemporaryStat.WizardIgnite)) {
                    ...
                    o1.rOption = skillID;
                    o1.tOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.WizardIgnite, o1);
                }
                break;
            ...
            case TELEPORT_MASTERY_BISH:
                CharacterTemporaryStat masteryStat = skillID == TELEPORT_MASTERY_RANGE_IL ? CharacterTemporaryStat.TeleportMasteryRange : CharacterTemporaryStat.TeleportMasteryOn;
            ...
            case INFINITY_BISH:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Infinity, o1);
                o2.nOption = si.getValue(SkillStat.prop, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Stance, o2);
                infinityStack = 0;
            ...
            case VIRAL_SLIME:
                ...
                break;
            case BLESS:
                o1.nOption = si.getValue(SkillStat.u, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.PDD, o1);
                tsm.putCharacterStatValue(CharacterTemporaryStat.MDD, o1);
                o2.nOption = si.getValue(SkillStat.v, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVA, o2);
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.PAD, o3);
                tsm.putCharacterStatValue(CharacterTemporaryStat.MAD, o3);
                break;
            case ADV_BLESSING:
                o1.nOption = si.getValue(SkillStat.u, slv);
                o1.rOption = skillID;
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.PAD, o3);
                tsm.putCharacterStatValue(CharacterTemporaryStat.MAD, o3);
                o4.nValue = si.getValue(SkillStat.indieMhp, slv);
                o4.nReason = skillID;
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMHP, o4);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMMP, o4);
                break;
            case HOLY_SYMBOL:
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
            ...
            case HOLY_MAGIC_SHELL:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.HolyMagicShell, o1);
                hmshits = 0;
            ...
            case THUNDER_STORM:
                ...
                break;
            case CHILLING_STEP:
                if (tsm.hasStat(CharacterTemporaryStat.ChillingStep)) {
                    tsm.removeStatsBySkill(skillID);
                    tsm.sendResetStatPacket();
                } else {
                    o1.rOption = skillID;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.ChillingStep, o1);
                }
                break;
            ...
            case ABSOLUTE_ZERO_AURA:
                ...
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.FireAura, o1);
                ...
                o3.rOption = skillID;
                o3.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamAbsorbShield, o3);
                o4.nOption = si.getValue(SkillStat.v, slv);
                o4.rOption = skillID;
                o4.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.AsrR, o4);
                tsm.putCharacterStatValue(CharacterTemporaryStat.TerR, o4);
                break;
            case INFERNO_AURA:
                o1.nOption = 1;
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IceAura, o1);
                break;
            case RIGHTEOUSLY_INDIGNANT:
                o1.nOption = 1;
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.VengeanceOfAngel, o1);
                o2.nReason = skillID;
                ...
                o3.nReason = skillID;
                o3.nValue = si.getValue(SkillStat.indiePMdR, slv);
                o3.tStart = (int) System.currentTimeMillis();
                o3.tTerm = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePMdR, o3);
                o4.nReason = skillID;
                o4.nValue = si.getValue(SkillStat.indieMaxDamageOver, slv);
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMaxDamageOver, o4);
                o5.nReason = skillID;
                o5.nValue = si.getValue(SkillStat.indieBooster, slv);
                o5.tStart = (int) System.currentTimeMillis();
                o5.tTerm = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieBooster, o5);
                o6.nOption = si.getValue(SkillStat.ignoreMobpdpR, slv);
                o6.rOption = skillID;
                o6.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreMobpdpR, o6);
                o7.nOption = si.getValue(SkillStat.w, slv);
                o7.rOption = skillID;
                o7.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.ElementalReset, o7);
                break;
    ...
    private void changeBlessedCount() {
        ...
        if(amount > 1) { // amount = 2  ->  1 count on Icon
            ...
            tsm.putCharacterStatValue(CharacterTemporaryStat.BlessEnsenble, o1);

            o2.nValue = si.getValue(SkillStat.x, slv) * amount;
    ...
    private int changeBishopHealingBuffs(int skillID) {
        ...
        switch (skillID) {
            case HEAL:
                rate = si.getValue(SkillStat.hp, slv);
                healrate = maxHP;// (int) (maxHP / ((double)100 / rate));
                break;
            case HOLY_MAGIC_SHELL:
                rate = si.getValue(SkillStat.z, slv);
        ...
        if(tsm.hasStat(CharacterTemporaryStat.VengeanceOfAngel)) {
            SkillInfo hsi = SkillData.getSkillInfoById(RIGHTEOUSLY_INDIGNANT);
            healrate = (int) (healrate / ((double) 100 / (hsi.getValue(SkillStat.hp, 1))));
        }
        return healrate;
    }
    ...
    private void infinity() {
        ...
        SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
        infinityStack++;
        if(tsm.hasStat(CharacterTemporaryStat.Infinity)) {
            o1.nValue = infinityStack * si.getValue(SkillStat.damage, slv);
            o1.nReason = getInfinitySkill()+100; //To make the buff icon hidden
            o1.tStart = (int) System.currentTimeMillis();
            tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMADR, o1);
            tsm.sendSetStatPacket();
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        switch (attackInfo.skillId) {
            ...
            case HEAVENS_DOOR:
                ...
                if (party != null) {
                    for(PartyMember partyMember : party.getOnlineMembers()) {
                        ...
                        o1.tOption = 0;
                        partyTSM.putCharacterStatValue(CharacterTemporaryStat.ReviveOnce, o1);
                    ...
                    o1.rOption = HEAVENS_DOOR;
                    o1.tOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.ReviveOnce, o1);
                    tsm.sendSetStatPacket();
                }
                break;
            case ANGEL_RAY:
            ...
            case GENESIS:
                o1.nOption = 1;
                o1.rOption = BIG_BANG;
                o1.tOption = si.getValue(SkillStat.cooltime, slv);
    ...
    private void incrementArcaneAim() {
        ...
        byte slv = (byte) skill.getCurrentLevel();
        int arcaneAimProp = arcaneAimInfo.getValue(SkillStat.prop, slv);
        ...
        Option o2 = new Option();
        int amount = 1;
        if (tsm.hasStat(CharacterTemporaryStat.ArcaneAim)) {
            amount = tsm.getOption(CharacterTemporaryStat.ArcaneAim).nOption;
            if (amount < arcaneAimInfo.getValue(SkillStat.y, slv)) {
                amount++;
            }
        }
        o.nOption = amount;
        ...
        tsm.putCharacterStatValue(CharacterTemporaryStat.ArcaneAim, o);
        o1.nOption = arcaneAimInfo.getValue(SkillStat.ignoreMobpdpR, slv);
        o1.rOption = 2320011;
        o1.tOption = 5; // No Time Variable
        tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreMobpdpR, o1);
        o2.nOption = (amount * arcaneAimInfo.getValue(SkillStat.x, slv));
        o2.rOption = 2320011;
    ...
    private void applyIgniteOnMob(AttackInfo attackInfo, TemporaryStatManager tsm) {
        ...
        if (tsm.hasStat(CharacterTemporaryStat.WizardIgnite)) {
            ...
            for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
                ...
                if (Util.succeedProp(igniteInfo.getValue(SkillStat.prop, slv))) {
    ...
    private void fpBurnedInfo(Mob mob, Skill attackSkill) {
        ...
        int biDuration = SkillData.getSkillInfoById(attackSkill.getSkillId()).getValue(SkillStat.dotTime, attackSlv);
        MobTemporaryStat mts = mob.getTemporaryStat();
    ...
    private void updateElementDrain() {
        ...
        tsm.putCharacterStatValue(CharacterTemporaryStat.DotBasedBuff, o);

        o1.nOption = ( (getFerventDrainStack() > 5 ? 5 : getFerventDrainStack()) * edi.getValue(SkillStat.x, slv) );
        ...
        if (isBuff(skillID)) {
            ...
            switch (skillID) {
                ...
                case MYSTIC_DOOR:
                    ...
                    int duration = si.getValue(SkillStat.time, slv);
    ...
    private void createChillStepAA() {
        ...
        if (tsm.hasStat(CharacterTemporaryStat.ChillingStep) && Util.succeedProp(chillingStepInfo.getValue(SkillStat.prop, slv))) {
    ...
    public void handleHit(Client c, InPacket inPacket, HitInfo hitInfo) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if(tsm.hasStat(CharacterTemporaryStat.MagicGuard)) {
            Skill skill = chr.getSkill(MAGIC_GUARD);
            SkillInfo si = SkillData.getSkillInfoById(MAGIC_GUARD);
            int dmgPerc = si.getValue(SkillStat.x, skill.getCurrentLevel());
    ...
    public void handleMobDebuffSkill(Char chr) {
        ...
        if(chr.hasSkill(ELEMENTAL_ADAPTATION_FP) && tsm.getOptByCTSAndSkill(CharacterTemporaryStat.AntiMagicShell, ELEMENTAL_ADAPTATION_FP) != null) {
            deductEleAdaptationFP();
            tsm.removeAllDebuffs();
        }

        // Elemental Adaptation - IL
        if(chr.hasSkill(ELEMENTAL_ADAPTATION_IL) && tsm.getOptByCTSAndSkill(CharacterTemporaryStat.AntiMagicShell, ELEMENTAL_ADAPTATION_IL) != null) {
            if(tsm.getOption(CharacterTemporaryStat.AntiMagicShell).bOption == 0) {
        ...
        if(chr.hasSkill(DIVINE_PROTECTION) && tsm.getOptByCTSAndSkill(CharacterTemporaryStat.AntiMagicShell, DIVINE_PROTECTION) != null) {
    ...
    private void deductEleAdaptationFP() {
        ...
        int stack = tsm.getOption(CharacterTemporaryStat.AntiMagicShell).nOption;
        if(stack > 0) {
