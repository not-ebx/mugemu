...
public class WildHunter extends Citizen {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case SUMMON_JAGUAR_CRIMSON:
                ...
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.JaguarSummoned, o1);
                tsm.putCharacterStatValue(CharacterTemporaryStat.JaguarCount, o1);
                break;
            case RIDE_JAGUAR:
                if (chr.getWildHunterInfo() == null
                        || chr.getWildHunterInfo().getIdx() < 0
            ...
            case CALL_OF_THE_WILD:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.z, slv);
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.Guard, o2);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVAR, o2);
                o3.nReason = skillID;
                o3.nValue = si.getValue(SkillStat.x, slv);
                o3.tStart = (int) System.currentTimeMillis();
                o3.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMMPR, o3);
                break;
            case FELINE_BERSERK:
                o1.nReason = skillID;
            ...
            case BACKSTEP:
                ...
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.DrawBack, o1);
                break;
            case SHARP_EYES: // x = crit rate%  |  y = max crit dmg%
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.SharpEyes, o1);
                break;
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        Option o2 = new Option();
        Option o3 = new Option();
        int jaguarBleedingTime = SkillData.getSkillInfoById(SUMMON_JAGUAR_GREY).getValue(SkillStat.time, 1);
    ...
    private int getFinalAttackProc() {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if(tsm.getOptByCTSAndSkill(CharacterTemporaryStat.IndieDamR, SILENT_RAMPAGE) != null) {
            return 100;
        }
                ...
                case CAPTURE:
                    ...
                    if (life instanceof Mob) {
                        ...
                        if (key != null) {
                            ...
                            chr.write(WvsContext.message(
                                MessageType.QUEST_RECORD_EX_MESSAGE,
