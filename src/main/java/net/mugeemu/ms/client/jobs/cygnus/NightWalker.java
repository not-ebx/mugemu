...
import net.mugeemu.ms.connection.packet.Summoned;
...
public class NightWalker extends Noblesse {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            case DARK_ELEMENTAL:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.ElementDarkness, o1);
                break;
            case HASTE:
                ...
                o3.nOption = si.getValue(SkillStat.er, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVAR, o3);
                break;
            case DARK_SIGHT:
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
            ...
            case SHADOW_BAT:
                if(tsm.hasStatBySkillId(skillID)) {
                    ...
                    o1.rOption = skillID;
                    o1.tOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.NightWalkerBat, o1);
                }
                break;
            ...
            case SHADOW_ILLUSION:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.ShadowIllusion, o1);
                ...
                if(chr.hasSkill(DARK_SERVANT)) {
                    EventManager.addEvent(this::applyDarkServant, si.getValue(SkillStat.time, slv) * 1001, TimeUnit.MILLISECONDS);
                }
                break;
            case DARK_OMEN:
    ...
    private void applyDarkServant() {
        ...
        o1.tOption = si.getValue(SkillStat.time, slv);
        tsm.putCharacterStatValue(CharacterTemporaryStat.ShadowServant, o1);
        tsm.sendSetStatPacket();
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        if(hasHitMobs) {
            ...
            if (attackInfo.skillId == DARK_OMEN) {
                ...
                int attForBats = si.getValue(SkillStat.x, slv);
            ...
            if (attackInfo.skillId != DARK_OMEN && attackInfo.skillId != SHADOW_BAT_ATOM && chr.hasSkillOnCooldown(DARK_OMEN)) {
                ...
                chr.reduceSkillCoolTime(DARK_OMEN, skillInfo.getValue(SkillStat.y, slv));
            }
        ...
        switch (attackInfo.skillId) {
            case SHADOW_STITCH:
                for(MobAttackInfo mai : attackInfo.mobAttackInfo) {
                    ...
                    o1.nOption = 1;
                    o1.rOption = skill.getSkillId();
                    o1.tOption = (si.getValue(SkillStat.time, slv) + attackInfo.mobAttackInfo.size() > 25 ? 25 : si.getValue(
                        SkillStat.time, slv) + attackInfo.mobAttackInfo.size());
    ...
    private void shadowBats(AttackInfo attackInfo) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if(!tsm.hasStat(CharacterTemporaryStat.NightWalkerBat)) {
            return;
        }
        for(MobAttackInfo mai : attackInfo.mobAttackInfo) {
            Mob mob = (Mob) chr.getField().getLifeByObjectID(mai.mobId);
    ...
    private int getMaxBats() {
        ...
        for(int batSkill : batSkills) {
            ...
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            byte slv = (byte) skill.getCurrentLevel();
            maxBats += si.getValue(SkillStat.y, slv);
        }
        return maxBats;
    }
    ...
    private int getBatAttackProp() {
        ...
        for(int batSkill : batSkills) {
            ...
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            byte slv = (byte) skill.getCurrentLevel();
            batAttackProp += si.getValue(SkillStat.prop, slv);
        }
    ...
    private int getMaxDarkEleStack() {
        ...
        for(int darkEleSkill : darkEleSkills) {
            if(chr.hasSkill(darkEleSkill)) {
                ...
                SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
                byte slv = (byte) skill.getCurrentLevel();
                maxStack += si.getValue(SkillStat.x, slv);
            }
        }
        return maxStack;
    }
    ...
    private int getDarkEleProp() {
        ...
        for(int darkEleSkill : darkEleSkills) {
            if(chr.hasSkill(darkEleSkill)) {
                ...
                SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
                byte slv = (byte) skill.getCurrentLevel();
                proc += si.getValue(SkillStat.prop, slv);
            }
        }
        return proc;
    }
    ...
    private void incrementSiphonVitality(TemporaryStatManager tsm) {
        ...
        if(tsm.hasStat(CharacterTemporaryStat.ElementDarkness)) {
            ...
            o.tOption = siphonInfo.getValue(SkillStat.time, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.SiphonVitality, o);
            o1.nOption = (amount * siphonInfo.getValue(SkillStat.y, slv));
            o1.rOption = VITALITY_SIPHON;
            o1.tOption = siphonInfo.getValue(SkillStat.time, slv);
    ...
    public static int getDarkOmenBatCount(Char chr) {
        if (chr.hasSkill(DARK_OMEN)) {
            ...
            return si.getValue(SkillStat.z, chr.getSkillLevel(DARK_OMEN));
        }
        return 0;
    }
}
