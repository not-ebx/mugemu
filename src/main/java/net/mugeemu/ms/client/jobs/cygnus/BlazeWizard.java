...
public class BlazeWizard extends Noblesse {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case FIRES_OF_CREATION_LION:
                ...
                summon.setSummonTerm(SkillData.getSkillInfoById(FIRES_OF_CREATION).getValue(SkillStat.time, slv));
                ...
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.y, slv);
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.ElementalReset, o2);
                break;
            ...
            case ORBITAL_FLAME_RANGE:
                if (tsm.hasStat(CharacterTemporaryStat.AddRangeOnOff)) {
                    ...
                    o1.nOption = si.getValue(SkillStat.range, slv);
                    o1.rOption = skillID;
                    o1.tOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.AddRangeOnOff, o1);
                }
                break;
        }
    ...
    private void summonFlameElement() {
        ...
        if(tsm.getOptByCTSAndSkill(CharacterTemporaryStat.MAD, getFlameElement()) == null) {
            Option o1 = new Option();
            Option o2 = new Option();
            ...
            o2.tStart = (int) System.currentTimeMillis();
            o2.tTerm = si.getValue(SkillStat.time, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.IndieEmpty, o2);
            ...
            for(MobAttackInfo mai : attackInfo.mobAttackInfo) {
                if (Util.succeedProp(si.getValue(SkillStat.prop, slv))) {
                    ...
                    schFuture = EventManager.addEvent(() ->
                            explodeIgnitionOnMob(mob), si.getValue(SkillStat.dotTime, slv), TimeUnit.SECONDS);
        ...
        if (isBuff(skillID)) {
            ...
            switch(skillID) {
                ...
                case CONTROLLED_BURN:
                    int healmp = si.getValue(SkillStat.x, slv);
    ...
    public static void reviveByPhoenixRun(Char chr) {
        ...
        o.tOption = si.getValue(SkillStat.x, slv); // duration
