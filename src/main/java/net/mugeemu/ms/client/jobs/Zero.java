...
import net.mugeemu.ms.client.character.ExtendSP;
import net.mugeemu.ms.client.character.SPSet;
...
import net.mugeemu.ms.constants.QuestConstants;
import net.mugeemu.ms.constants.SkillConstants;
import net.mugeemu.ms.loaders.QuestData;
...
public class Zero extends Job {
        ...
        switch (skillID) {
            case DIVINE_FORCE:
                if(tsm.hasStatBySkillId(skillID)) {
                    ...
                    o1.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieAsrR, o1); //Indie
                    o2.nReason = skillID;
                    o2.nValue = si.getValue(SkillStat.indieMad, slv);
                    o2.tStart = (int) System.currentTimeMillis();
                    o2.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMAD, o2); //Indie
                    o3.nReason = skillID;
                    o3.nValue = si.getValue(SkillStat.indiePad, slv);
                    o3.tStart = (int) System.currentTimeMillis();
                    o3.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePAD, o3); //Indie
                    o4.nReason = skillID;
                    o4.nValue = si.getValue(SkillStat.indieMdd, slv);
                    o4.tStart = (int) System.currentTimeMillis();
                    o4.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMDD, o4); //Indie
                    o5.nReason = skillID;
                    o5.nValue = si.getValue(SkillStat.indiePdd, slv);
                    o5.tStart = (int) System.currentTimeMillis();
                    o5.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePDD, o5); //Indie
                    o6.nReason = skillID;
                    o6.nValue = si.getValue(SkillStat.indieTerR, slv);
                    o6.tStart = (int) System.currentTimeMillis();
                    o6.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieTerR, o6); //Indie
                    o7.nOption = 1;
                    o7.rOption = skillID;
                    o7.tOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.ZeroAuraStr, o7);
                }
                break;
            case DIVINE_SPEED:
                if(tsm.hasStatBySkillId(skillID)) {
                    ...
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieACC, o1); //Indie
                    o2.nReason = skillID;
                    o2.nValue = si.getValue(SkillStat.indieBooster, slv);
                    o2.tStart = (int) System.currentTimeMillis();
                    o2.tTerm = si.getValue(SkillStat.time, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieBooster, o2); //Indie
                    o3.nReason = skillID;
                    o3.nValue = si.getValue(SkillStat.indieEva, slv);
                    o3.tStart = (int) System.currentTimeMillis();
                    o3.tTerm = si.getValue(SkillStat.time, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieEVA, o3); //Indie
                    o4.nReason = skillID;
                    o4.nValue = si.getValue(SkillStat.indieJump, slv);
                    o4.tStart = (int) System.currentTimeMillis();
                    o4.tTerm = si.getValue(SkillStat.time, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieJump, o4); //Indie
                    o5.nReason = skillID;
                    o5.nValue = si.getValue(SkillStat.indieSpeed, slv);
                    o5.tStart = (int) System.currentTimeMillis();
                    o5.tTerm = si.getValue(SkillStat.time, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieSpeed, o5); //Indie
                    o6.nOption = 1;
                    o6.rOption = skillID;
                    o6.tOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.ZeroAuraSpd, o6);
                }
                break;
            ...
            case TIME_HOLDING:
                ...
                if(chr.getStat(Stat.level) >= 200) {
                    ...
                    o3.nValue = si.getValue(SkillStat.z, slv);
                    o3.tStart = (int) System.currentTimeMillis();
                    o3.tTerm = si.getValue(SkillStat.x, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMaxDamageOverR, o3);
                }
            ...
            case FOCUSED_TIME:
                ...
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = 2400;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMADR, o2); //Indie
                break;
        }
    ...
    private void incrementDoubleTimeAlpha(int skillID) {
        if (chr.hasSkill(DOUBLE_TIME)) {
            ...
            int amount = 1;
            if (tsm.hasStat(CharacterTemporaryStat.TimeFastABuff)) {
                if (doubleTimePrevSkill == skillID) {
                    return;
                }
                amount = tsm.getOption(CharacterTemporaryStat.TimeFastABuff).nOption;
                if (amount < 10) {
                    amount++;
                }
            }
            ...
            o.tOption = 20;
            tsm.putCharacterStatValue(CharacterTemporaryStat.TimeFastABuff, o);
            tsm.sendSetStatPacket();
        }
    }
    ...
    private void incrementDoubleTimeBeta(int skillID) {
        if (chr.hasSkill(DOUBLE_TIME)) {
            ...
            int amount = 1;
            if (tsm.hasStat(CharacterTemporaryStat.TimeFastBBuff)) {
                if (doubleTimePrevSkill == skillID) {
                    return;
                }
                amount = tsm.getOption(CharacterTemporaryStat.TimeFastBBuff).nOption;
                if (amount < 10) {
                    amount++;
                }
            }
            ...
            o.tOption = 20;
            tsm.putCharacterStatValue(CharacterTemporaryStat.TimeFastBBuff, o);
            tsm.sendSetStatPacket();
        }
    }
    ...
    public void handleHit(Client c, InPacket inPacket, HitInfo hitInfo) {
        ...
        if(Util.succeedProp(si.getValue(SkillStat.prop, slv))) {
            ...
            o.nOption = max;
            o.xOption = max;
            chr.getTemporaryStatManager().putCharacterStatValue(CharacterTemporaryStat.ImmuneBarrier, o);
        }
        if(tsm.hasStat(CharacterTemporaryStat.ImmuneBarrier)) {
            Option o = tsm.getOption(CharacterTemporaryStat.ImmuneBarrier);
            ...
            tsm.putCharacterStatValue(CharacterTemporaryStat.ImmuneBarrier, o);
            tsm.sendSetStatPacket();
        }
