...
public class Phantom extends Job {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case BAD_LUCK_WARD:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.AsrR, o3);
            ...
            case CLAIR_DE_LUNE:
                ...
                o2.nValue = si.getValue(SkillStat.indieAcc, slv);
                o2.nReason = skillID;
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieACC, o2);
                break;
            case PRIERE_DARIA:
    ...
    private void giveJudgmentDrawBuff(int skillId) {
        ...
        switch (randomInt) {
            case 1: // Crit Rate
                xOpt = si.getValue(SkillStat.v, slv);
                break;
            case 2: // Item Drop Rate
                xOpt = si.getValue(SkillStat.w, slv);
                break;
            case 3: // AsrR & TerR
                xOpt = si.getValue(SkillStat.x, slv);
                break;
            case 4: // Defense %
                xOpt = 10;
                break;
        ...
        o.xOption = xOpt;
        tsm.putCharacterStatValue(CharacterTemporaryStat.Judgement, o);
        tsm.sendSetStatPacket();
    }
    ...
    private void drainLifeByJudgmentDraw() {
        ...
        byte slv = (byte) skill.getCurrentLevel();
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if(tsm.hasStat(CharacterTemporaryStat.Judgement) && tsm.getOption(CharacterTemporaryStat.Judgement).nOption == 5) {
            int healrate = si.getValue(SkillStat.z, slv);
    ...
    public static void reviveByFinalFeint(Char chr) {
        ...
        o.nOption = 1;
        o.rOption = skill.getSkillId();
        o.tStart = si.getValue(SkillStat.y, slv);
        tsm.putCharacterStatValue(CharacterTemporaryStat.NotDamaged, o);
        tsm.sendSetStatPacket();
    }
