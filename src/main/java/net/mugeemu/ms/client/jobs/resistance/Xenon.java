...
public class Xenon extends Job {
    ...
    public Xenon(Char chr) {
        ...
        if(chr.getId() != 0 && isHandlerOfJob(chr.getJob())) {
            ...
            supplyProp = SkillData.getSkillInfoById(SUPPLY_SURPLUS).getValue(SkillStat.prop, 1);
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case EFFICIENCY_STREAMLINE:
                ...
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indieMmpR, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieMMPR, o2);
                break;
            case HYBRID_DEFENSES:
                ...
                hybridDefenseCount = si.getValue(SkillStat.x, slv);
                o1.nOption = 1;
                o1.rOption = skillID;
                ...
                break;
            case AEGIS_SYSTEM:
                if (tsm.hasStat(CharacterTemporaryStat.XenonAegisSystem)) {
                    tsm.removeStatsBySkill(skillID);
                    tsm.sendResetStatPacket();
                } else {
                    o1.nOption = 1;
                    o1.rOption = skillID;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.XenonAegisSystem, o1);
                }
                break;
            ...
            case OOPARTS_CODE:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.BdR, o2);
                break;
            ...
            case AMARANTH_GENERATOR:
                ...
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.AmaranthGenerator, o1);
                incrementSupply(20);
                break;
    ...
    private void applySupplyCost(int skillID, byte slv, SkillInfo si) {
        ...
        if(tsm.hasStat(CharacterTemporaryStat.AmaranthGenerator)) {
            return;
        } else {
            if (si == null) {
                return;
            }
            if (si.getValue(SkillStat.powerCon, slv) > 0) {
                supply -= si.getValue(SkillStat.powerCon, slv);
    ...
    private void incrementSupply(int amount) {
        if (supply < 20) {
            supply = chr.getTemporaryStatManager().getOption(CharacterTemporaryStat.SurplusSupply).nOption;
            supply += amount;
    ...
    private void updateSupply() {
        Option o = new Option();
        o.nOption = supply;
        chr.getTemporaryStatManager().putCharacterStatValue(CharacterTemporaryStat.SurplusSupply, o);
    ...
    public void handleAttack(Client c, AttackInfo attackInfo) {
        ...
        switch (attackInfo.skillId) {
            ...
            case ORBITAL_CATACLYSM:
                ...
                o1.nValue = si.getValue(SkillStat.indieDamR, slv);
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.y, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o1);
                o2.nReason = skillID;
                o2.nValue = si.getValue(SkillStat.indieMaxDamageOverR, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = si.getValue(SkillStat.y, slv);
        ...
        if (isBuff(skillID)) {
            ...
            switch (skillID) {
                case EMERGENCY_RESUPPLY:
                    incrementSupply(si.getValue(SkillStat.x, slv));
                    break;
                case TEMPORAL_POD:
                    AffectedArea aa = AffectedArea.getPassiveAA(chr, skillID, slv);
                    aa.setMobOrigin((byte) 0);
                ...
                case PINPOINT_SALVO:
                    o1.nOption = supply--;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.SurplusSupply, o1);
                    updateSupply();
    ...
    public void handleHit(Client c, InPacket inPacket, HitInfo hitInfo) {
        ...
        if(chr.hasSkill(HYBRID_DEFENSES)) {
            ...
            if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.StackBuff, HYBRID_DEFENSES) != null) {
        ...
        if (tsm.hasStat(CharacterTemporaryStat.XenonAegisSystem) && aegis != null) {
            ...
            if (Util.succeedProp(si.getValue(SkillStat.prop, slv))) {
                ...
                for (int i = 0; i < si.getValue(SkillStat.x, slv); i++) {
