...
public class DawnWarrior extends Noblesse {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case FALLING_MOON:
                ...
                o2.nOption = chr.hasSkill(MASTER_OF_THE_SWORD) ? mosSI.getValue(SkillStat.indieCr, slv) : si.getValue(
                    SkillStat.indieCr, slv);
                o2.rOption = skillID;
            ...
            case RISING_SUN:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.PoseType, o1);
                o2.nReason = skillID;
                o2.nValue = chr.hasSkill(MASTER_OF_THE_SWORD) ? mosSI.getValue(SkillStat.v, slv) : si.getValue(SkillStat.indieDamR, slv);
                o2.tStart = (int) System.currentTimeMillis();
                o2.tTerm = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o2); //Indie
                o3.nOption = chr.hasSkill(MASTER_OF_THE_SWORD) ? -2 : si.getValue(SkillStat.indieBooster, slv);
                o3.rOption = skillID;
            ...
            case EQUINOX_CYCLE:
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.GlimmeringTime, o5);
                break;
    ...
    private void willOfSteel() { //TODO needs to be called
        if(chr.hasSkill(WILL_OF_STEEL)) {
            ...
            int interval = si.getValue(SkillStat.w, slv);
            int heal = (int) (chr.getMaxHP() / ((double) 100 / si.getValue(SkillStat.y, slv)));
        ...
        if(tsm.hasStat(CharacterTemporaryStat.GlimmeringTime)) {
            if(tsm.getOption(CharacterTemporaryStat.PoseType).nOption == 1) {
                ...
                tsm.removeStatsBySkill(EQUINOX_CYCLE_SUN);
                    ...
                    o2.nValue = chr.hasSkill(MASTER_OF_THE_SWORD) ? mosSI.getValue(SkillStat.v, slvRS) : siRS.getValue(
                        SkillStat.indieDamR, slvRS);
                    o2.tStart = (int) System.currentTimeMillis();
                    o2.tTerm = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o2); //Indie

                    o3.nOption = chr.hasSkill(MASTER_OF_THE_SWORD) ? -2 : siRS.getValue(SkillStat.indieBooster, slvRS);
                    o3.rOption = RISING_SUN;
                    o3.tOption = siRS.getValue(SkillStat.time, slvRS);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoBooster, o3);
                ...
                o5.nOption = chr.hasSkill(MASTER_OF_THE_SWORD) ? mosSI.getValue(SkillStat.indieCr, slvFM) : siFM.getValue(
                    SkillStat.indieCr, slvFM);
                o5.rOption = EQUINOX_CYCLE_MOON;
                tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoCr, o5);
            } else {
                ...
                o2.nOption = chr.hasSkill(MASTER_OF_THE_SWORD) ? mosSI.getValue(SkillStat.indieCr, slvFM) : siFM.getValue(
                    SkillStat.indieCr, slvFM);
                o2.rOption = FALLING_MOON;
                o2.tOption = siFM.getValue(SkillStat.time, slvFM);
                tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoCr, o2);
                ...
                o4.nValue = chr.hasSkill(MASTER_OF_THE_SWORD) ? mosSI.getValue(SkillStat.v, slvRS) : siRS.getValue(
                    SkillStat.indieDamR, slvRS);
                o4.tStart = (int) System.currentTimeMillis();
                o4.tTerm = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.IndieDamR, o4);

                o5.nOption = chr.hasSkill(MASTER_OF_THE_SWORD) ? -2 : siRS.getValue(SkillStat.indieBooster, slvRS);
                o5.rOption = EQUINOX_CYCLE_SUN;
                o5.tOption = siRS.getValue(SkillStat.time, slvRS);
                tsm.putCharacterStatValue(CharacterTemporaryStat.HayatoBooster, o5);
            }
            tsm.sendSetStatPacket();
        } else {
            if(tsm.getOptByCTSAndSkill(CharacterTemporaryStat.BuckShot, EQUINOX_CYCLE_MOON) != null) {
                tsm.removeStatsBySkill(EQUINOX_CYCLE_MOON);
            }
            if(tsm.getOptByCTSAndSkill(CharacterTemporaryStat.HayatoBooster, EQUINOX_CYCLE_SUN) != null) {
                tsm.removeStatsBySkill(EQUINOX_CYCLE_SUN);
            }
        }
    }
