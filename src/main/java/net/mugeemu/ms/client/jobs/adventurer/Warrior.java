...
import net.mugeemu.ms.client.party.Party;
import net.mugeemu.ms.client.party.PartyMember;
...
public class Warrior extends Beginner {
    ...
    public void handleBuff(Client c, InPacket inPacket, int skillID, byte slv) {
        ...
        switch (skillID) {
            ...
            case RAGE:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indiePad, slv);
                ...
                tsm.putCharacterStatValue(CharacterTemporaryStat.PowerGuard, o2);
                break;
            case COMBO_ATTACK:
                o1.nOption = 1;
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.ComboCounter, o1);
                break;
            case ENRAGE:
                removeCombo(chr, 1);
                o1.nOption = 1;
                o1.rOption = skillID;
                tsm.putCharacterStatValue(CharacterTemporaryStat.Enrage, o1); // max mobs hit
                o2.nOption = si.getValue(SkillStat.y, slv);
                o2.rOption = skillID;
                tsm.putCharacterStatValue(CharacterTemporaryStat.EnrageCrDamMin, o2);
                o3.nOption = si.getValue(SkillStat.x, slv);
                o3.rOption = skillID;
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamR, o3);
                break;
            case COMBAT_ORDERS:
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.CombatOrders, o1);
                break;
            case PARASHOCK_GUARD:
                o1.nOption = 1;
                o1.rOption = skillID;
                o1.tOption = 0;
                tsm.putCharacterStatValue(CharacterTemporaryStat.EVA, o1); // Check for the main Buff method
            ...
            case IRON_WILL:
                ...
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.MDD, o2);
                break;
            case HYPER_BODY:
                o1.nOption = si.getValue(SkillStat.x, slv);
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.MaxHP, o1);
                o2.nOption = si.getValue(SkillStat.y, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.MaxMP, o2);
                break;
            case CROSS_SURGE:
                int totalHP = c.getChr().getMaxHP();
                int currentHP = c.getChr().getHP();
                o1.nOption = (int) ((si.getValue(SkillStat.x, slv) * ((double) currentHP) / totalHP));
                o1.rOption = skillID;
                o1.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamR, o1);
                o2.nOption = (int) Math.min((0.08 * totalHP - currentHP), si.getValue(SkillStat.z, slv));
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamageReduce, o2);
                break;
            case EVIL_EYE:
                spawnEvilEye(skillID, slv);
                break;
            case EVIL_EYE_OF_DOMINATION:
                if (tsm.hasStat(CharacterTemporaryStat.Beholder)) {
                    ...
                    o1.sOption = skillID;
                    o1.ssOption = 0;
                    tsm.putCharacterStatValue(CharacterTemporaryStat.Beholder, o1);
                }
                break;
            case EVIL_EYE_SHOCK:
                if (tsm.getOption(CharacterTemporaryStat.Beholder).nOption > 0 && tsm.getOption(CharacterTemporaryStat.Beholder).sOption > 0) //If evil eye and domination is active
                {
                    slv = (byte) chr.getSkill(EVIL_EYE).getCurrentLevel();
                    Option o = new Option();
                    o.nOption = tsm.getOption(CharacterTemporaryStat.Beholder).nOption;
                    o.rOption = tsm.getOption(CharacterTemporaryStat.Beholder).rOption;
                    o.tOption = tsm.getOption(CharacterTemporaryStat.Beholder).tOption;
                    o.sOption = tsm.getOption(CharacterTemporaryStat.Beholder).sOption;
                    o.ssOption = EVIL_EYE_SHOCK;
                    //Remove after getting the options
                    tsm.removeStatsBySkill(EVIL_EYE_OF_DOMINATION);
                    spawnEvilEye(EVIL_EYE, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.Beholder, o);
                }
                break;
            case SACRIFICE:
                if (tsm.hasStatBySkillId(EVIL_EYE)) {
                    ...
                    o3.nReason = skillID;
                    o3.nValue = si.getValue(SkillStat.indieBDR, slv);
                    ...
                    chr.heal((int) (chr.getMaxHP() / ((double) 100 / si.getValue(SkillStat.y, slv))));
            ...
            case BLAST:
                ...
                o2.nOption = si.getValue(SkillStat.damR, slv);
                o2.rOption = skillID;
                o2.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.DamR, o2);
                o3.nOption = si.getValue(SkillStat.ignoreMobpdpR, slv);
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreMobpdpR, o3);
                break;
            ...
            case CRY_VALHALLA:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indieCr, slv);
                o1.tStart = (int) System.currentTimeMillis();
                o1.tTerm = si.getValue(SkillStat.time, slv);
                ...
                o3.rOption = skillID;
                o3.tOption = si.getValue(SkillStat.time, slv);
                tsm.putCharacterStatValue(CharacterTemporaryStat.Stance, o3);
                break;
            case DARK_THIRST:
                o1.nReason = skillID;
                o1.nValue = si.getValue(SkillStat.indiePad, slv);
    ...
    public void spawnEvilEye(int skillID, byte slv) {
        ...
        o1.tStart = (int) System.currentTimeMillis();
        o1.tTerm = si.getValue(SkillStat.time, slv);
        tsm.putCharacterStatValue(CharacterTemporaryStat.IndieEmpty, o1);
        tsm.sendSetStatPacket();
    }
    ...
    private void addCombo(Char chr) {
        ...
        if (chr.hasSkill(ADVANCED_COMBO)) {
            ...
            if (slv > 0 && Util.succeedProp(si.getValue(SkillStat.prop, slv))) {
                added = 2;
            }
        }
        Option o = new Option();
        ...
        tsm.putCharacterStatValue(CharacterTemporaryStat.ComboCounter, o);
        tsm.sendSetStatPacket();
    }
    ...
    private int getComboProp(Char chr) {
        ...
        return SkillData.getSkillInfoById(skill.getSkillId()).getValue(SkillStat.prop, skill.getCurrentLevel());
    }

    public int getComboCount(Char c) {
        TemporaryStatManager tsm = c.getTemporaryStatManager();
        if (tsm.hasStat(CharacterTemporaryStat.ComboCounter)) {
            return tsm.getOption(CharacterTemporaryStat.ComboCounter).nOption;
        }
        return -1;
    }
    ...
    private void giveParashockGuardBuff() {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if (chr.hasSkill(PARASHOCK_GUARD) && tsm.getOptByCTSAndSkill(CharacterTemporaryStat.EVA, PARASHOCK_GUARD) != null) {
            ...
            if (party != null) {
                for (PartyMember partyMember : party.getOnlineMembers()) {
                    ...
                    if (partyChrX >= rect.getLeft() && partyChrY >= rect.getTop()       // if  Party Members in Range
                        ...
                        o4.nOption = si.getValue(SkillStat.x, slv);
                        o4.rOption = skill.getSkillId();
                        o4.tOption = 2;
                        partyTSM.putCharacterStatValue(CharacterTemporaryStat.Guard, o4);
                        o5.nOption = chr.getId();
                        o5.rOption = skill.getSkillId();
                        o5.tOption = 2;
                        o5.bOption = 1;
                        partyTSM.putCharacterStatValue(CharacterTemporaryStat.KnightsAura, o5);
            ...
            o.bOption = 1;
            tsm.putCharacterStatValue(CharacterTemporaryStat.KnightsAura, o);
            o1.nReason = skill.getSkillId();
            o1.nValue = si.getValue(SkillStat.indiePad, slv);
            o1.tStart = (int) System.currentTimeMillis();
            tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePAD, o1);
            o2.nReason = skill.getSkillId();
            o2.nValue = si.getValue(SkillStat.z, slv);
            o2.tStart = (int) System.currentTimeMillis();
            tsm.putCharacterStatValue(CharacterTemporaryStat.IndiePDDR, o2);
            o3.nOption = -si.getValue(SkillStat.x, slv);
            o3.rOption = skill.getSkillId();
            tsm.putCharacterStatValue(CharacterTemporaryStat.Guard, o3);
    ...
    public void healByEvilEye() {
        ...
        if (chr.hasSkill(EVIL_EYE) && tsm.hasStatBySkillId(EVIL_EYE)) {
            ...
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            byte slv = (byte) skill.getCurrentLevel();
            chr.heal(si.getValue(SkillStat.hp, slv));
        }
    }
    ...
    public void giveHexOfTheEvilEyeBuffs() {
        ...
        byte slv = (byte) skill.getCurrentLevel();
        SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
        if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.EPDD, HEX_OF_THE_EVIL_EYE) == null) {
            o1.nOption = si.getValue(SkillStat.epad, slv);
            o1.rOption = skill.getSkillId();
            o1.tOption = si.getValue(SkillStat.time, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.EPAD, o1);

            o2.nOption = si.getValue(SkillStat.epdd, slv);
            o2.rOption = skill.getSkillId();
            o2.tOption = si.getValue(SkillStat.time, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.EPDD, o2);
            tsm.putCharacterStatValue(CharacterTemporaryStat.EMDD, o2);

            o3.nReason = skill.getSkillId();
            o3.nValue = si.getValue(SkillStat.indieCr, slv);
            o3.tStart = (int) System.currentTimeMillis();
            o3.tTerm = si.getValue(SkillStat.time, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.IndieCr, o3);

            o4.nOption = si.getValue(SkillStat.acc, slv);
            o4.rOption = skill.getSkillId();
            o4.tOption = si.getValue(SkillStat.time, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.ACC, o4);
            tsm.putCharacterStatValue(CharacterTemporaryStat.EVA, o4);
            tsm.sendSetStatPacket();
        }
    }
        ...
        switch (attackInfo.skillId) {
            case COMBO_FURY:
                ...
                for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
                    ...
                    if (Util.succeedProp(si.getValue(SkillStat.prop, skill.getCurrentLevel()))) {
                        if (!mob.isBoss()) {
                            o1.nOption = 1;
                            o1.rOption = skill.getSkillId();
                            o1.tOption = si.getValue(SkillStat.time, skill.getCurrentLevel());
            ...
            case COMBO_FURY_DOWN:
                ...
                break;
            case PANIC:
                if (tsm.hasStat(CharacterTemporaryStat.ComboCostInc)) {
                    int amount = tsm.getOption(CharacterTemporaryStat.ComboCostInc).nOption;
                    removeCombo(chr, 2 + amount);
                    o3.nOption = amount + 1;
                    o3.rOption = PANIC;
                    o3.tOption = si.getValue(SkillStat.subTime, slv);
                    tsm.putCharacterStatValue(CharacterTemporaryStat.ComboCostInc, o3);
                    tsm.sendSetStatPacket();
                } else {
                    o3.nOption = 1;
                    o3.rOption = PANIC;
                ...
                if (hasHitMobs) {
                    int allowedTime = si.getValue(SkillStat.subTime, slv);
                    for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
                        Mob mob = (Mob) chr.getField().getLifeByObjectID(mai.mobId);
                        if (mob == null) {
                            continue;
            ...
            case SHOUT:
                if (hasHitMobs) {
                    removeCombo(chr, si.getValue(SkillStat.y, slv));
                }
                break;
            case SHOUT_DOWN:
            ...
            case HEAVENS_HAMMER:
                break;
            case BLAST:
                int charges = tsm.getOption(CharacterTemporaryStat.ElementalCharge).mOption;
                if (charges == SkillData.getSkillInfoById(ELEMENTAL_CHARGE).getValue(SkillStat.z, 1)) {
                    if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.DamR, BLAST) == null) {
                        resetCharges(tsm);
                        int t = si.getValue(SkillStat.time, slv);
                        o1.nOption = si.getValue(SkillStat.cr, slv);
                        o1.rOption = skillID;
                        o1.tOption = t;
                        tsm.putCharacterStatValue(CharacterTemporaryStat.CriticalBuff, o1);
                        o2.nOption = si.getValue(SkillStat.ignoreMobpdpR, slv);
                        o2.rOption = skillID;
                        o2.tOption = t;
                        tsm.putCharacterStatValue(CharacterTemporaryStat.IgnoreMobpdpR, o2);
                        o3.nOption = si.getValue(SkillStat.damR, slv);
                        o3.rOption = skillID;
                        o3.tOption = t;
                        tsm.putCharacterStatValue(CharacterTemporaryStat.DamR, o3);
                        tsm.sendSetStatPacket();
            ...
            case FINAL_ATTACK_PAGE:
                ...
                break;
            case EVIL_EYE:
                if (tsm.getOption(CharacterTemporaryStat.Beholder).ssOption > 0) //If can use EVIL_EYE_SHOCK
                {
    ...
    private void darkThirst(TemporaryStatManager tsm) {
        if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.IndiePAD, DARK_THIRST) != null) {
            Skill skill = chr.getSkill(DARK_THIRST);
            byte slv = (byte) skill.getCurrentLevel();
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            int heal = si.getValue(SkillStat.x, slv);
    ...
    private void giveChargeBuff(int skillId, TemporaryStatManager tsm) {
        ...
        int amount = 1;
        if (tsm.hasStat(CharacterTemporaryStat.ElementalCharge)) {
            amount = tsm.getOption(CharacterTemporaryStat.ElementalCharge).mOption;
            if (lastCharge == skillId) {
                return;
            }
            if (amount < chargeInfo.getValue(SkillStat.z, 1)) {
                amount++;
            }
        }
        lastCharge = skillId;
        o.nOption = 1;
        o.rOption = 1200014;
        o.tOption = (10 * chargeInfo.getValue(SkillStat.time, 1)); // elemental charge  // 10x actual duration
        o.mOption = amount;
        o.wOption = amount * chargeInfo.getValue(SkillStat.w, 1); // elemental charge
        o.uOption = amount * chargeInfo.getValue(SkillStat.u, 1);
        o.zOption = amount * chargeInfo.getValue(SkillStat.z, 1);
        tsm.putCharacterStatValue(CharacterTemporaryStat.ElementalCharge, o);
        tsm.sendSetStatPacket();
    }

    private void resetCharges(TemporaryStatManager tsm) {
        tsm.removeStat(CharacterTemporaryStat.ElementalCharge, false);
        tsm.sendResetStatPacket();
    }
                    ...
                    for (Life life : chr.getField().getLifesInRect(rect)) {
                        if (life instanceof Mob && ((Mob) life).getHp() > 0) {
                            ...
                            if (Util.succeedProp(si.getValue(SkillStat.prop, slv))) {
                                ...
                                o2.nOption = -si.getValue(SkillStat.z, slv);
                                o2.rOption = skillID;
                                o2.tOption = si.getValue(SkillStat.subTime, slv);
                ...
                case GUARDIAN:
                    ...
                    if (party != null) {
                        ...
                        if (eligblePartyMemberList.size() > 0) {
                            ...
                            partyTSM.putCharacterStatValue(CharacterTemporaryStat.NotDamaged, o1);
                            partyTSM.sendSetStatPacket();
    ...
    public void hpRecovery() {
        ...
        if (chr.hasSkill(HP_RECOVERY)) {
            ...
            byte slv = (byte) skill.getCurrentLevel();
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            int recovery = si.getValue(SkillStat.x, slv);
            int amount = 10;

            if (tsm.hasStat(CharacterTemporaryStat.Restoration)) {
                amount = tsm.getOption(CharacterTemporaryStat.Restoration).nOption;
                if (amount < 300) {
                    amount = amount + 10;
                }
            }
            ...
            chr.heal((int) (chr.getMaxHP() / ((double) 100 / heal)));
            tsm.putCharacterStatValue(CharacterTemporaryStat.Restoration, o);
            tsm.sendSetStatPacket();
        }
    }
    ...
    public void handleHit(Client c, InPacket inPacket, HitInfo hitInfo) {
        ...
        if (chr.hasSkill(DIVINE_SHIELD)) {
            ...
            Option o1 = new Option();
            Option o2 = new Option();
            int divShieldCoolDown = si.getValue(SkillStat.cooltime, slv);
            if (tsm.hasStat(CharacterTemporaryStat.BlessingArmor)) {
                ...
                if (lastDivineShieldHit + (divShieldCoolDown * 1000) < System.currentTimeMillis()) {
                    if (Util.succeedProp(shieldprop)) {
                        ...
                        o1.tOption = si.getValue(SkillStat.time, slv);
                        tsm.putCharacterStatValue(CharacterTemporaryStat.BlessingArmor, o1);
                        o2.nOption = si.getValue(SkillStat.epad, slv);
        ...
        if (chr.hasSkill(1210001)) { //If Wearing a Shield
            if (hitInfo.hpDamage == 0 && hitInfo.mpDamage == 0) {
                ...
                if (mob != null) {
                    ...
                    byte slv = (byte) skill.getCurrentLevel();
                    SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
                    int proc = si.getValue(SkillStat.subProp, slv);
        ...
        if (chr.hasSkill(1320011)) {
            ...
            SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
            int proc = si.getValue(SkillStat.prop, slv);
            int cd = 1000 * si.getValue(SkillStat.cooltime, slv);
            int heal = si.getValue(SkillStat.x, slv);
            if (tsm.getOptByCTSAndSkill(CharacterTemporaryStat.PDD, EVIL_EYE) != null) {
    ...
    private void resetDivineShield() {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        tsm.removeStat(CharacterTemporaryStat.BlessingArmor, false);
        tsm.removeStat(CharacterTemporaryStat.PAD, false);
        tsm.sendResetStatPacket();
    }
    ...
    public static void reviveByFinalPact(Char chr) {
        ...
        if (isFinalPactAvailable(chr)) {
            ...
            o1.tOption = si.getValue(SkillStat.time, slv) * 1000;
            o1.xOption = si.getValue(SkillStat.z, slv);
            tsm.putCharacterStatValue(CharacterTemporaryStat.Reincarnation, o1);
            o2.nOption = 1;
            ...
            finishFinalPact = System.currentTimeMillis() + (si.getValue(SkillStat.time, slv) * 1000);
            chr.write(UserLocal.skillCooltimeSetM(1321013, 0));
        }
    }
    ...
    public static boolean isFinalPactAvailable(Char chr) {
        ...
        SkillInfo si = SkillData.getSkillInfoById(skill.getSkillId());
        byte slv = (byte) skill.getCurrentLevel();
        return lastFinalPact + (si.getValue(SkillStat.cooltime, slv) * 1000) < System.currentTimeMillis();
    }
    ...
    private void lowerFinalPactKillCount() {
        ...
        Option o = new Option();
        Skill skill = chr.getSkill(FINAL_PACT_INFO);
        if (skill == null || !tsm.hasStat(CharacterTemporaryStat.Reincarnation)) {
            return;
        }
        int duration = (int) (finishFinalPact - System.currentTimeMillis());

        killCount = tsm.getOption(CharacterTemporaryStat.Reincarnation).xOption;
        if (killCount > 0) {
            killCount--;
            ...
            if (duration > 0) {
                ...
                o.tOption = duration;
                o.xOption = killCount;
                tsm.putCharacterStatValue(CharacterTemporaryStat.Reincarnation, o);
                tsm.sendSetStatPacket();
            } else {
    ...
    private void killCountFinalPactOnMob(AttackInfo attackInfo) {
        TemporaryStatManager tsm = chr.getTemporaryStatManager();
        if (!tsm.hasStat(CharacterTemporaryStat.Reincarnation)) {
            return;
        }
        for (MobAttackInfo mai : attackInfo.mobAttackInfo) {
            Mob mob = (Mob) chr.getField().getLifeByObjectID(mai.mobId);
